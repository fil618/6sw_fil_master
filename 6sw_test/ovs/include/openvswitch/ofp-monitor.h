...
struct ofpbuf *ofputil_encode_anomaly_detection_p2(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection2_p1(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection2_p2(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection3_p1(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection3_p2(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection4_p1(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection4_p2(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection4_p4(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection4_p3(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection5_p1(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection5_p2(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection5_p3(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection6_p1(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection6_p2(enum ofputil_protocol);
struct ofpbuf *ofputil_encode_anomaly_detection6_p3(enum ofputil_protocol);
