 ...
 * alongside the standard versions above. */
    ...
    /* OFPT 1.0+ (154): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION,

    /* OFPT 1.0+ (155): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_O,

    /* OFPT 1.0+ (156): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_T_O,

    /* OFPT 1.0+ (157): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_T_T,

    /* OFPT 1.0+ (158): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_TH_O,

    /* OFPT 1.0+ (159): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_TH_T,

    /* OFPT 1.0+ (160): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_FO_O,

    /* OFPT 1.0+ (161): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_FO_T,

    /* OFPT 1.0+ (162): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_FO_TH,

    /* OFPT 1.0+ (168): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_FO_F,

    /* OFPT 1.0+ (163): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_FI_O,

    /* OFPT 1.0+ (164): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_FI_T,

    /* OFPT 1.0+ (169): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_FI_TH,

    /* OFPT 1.0+ (165): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_SI_O,

    /* OFPT 1.0+ (166): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_SI_T,

    /* OFPT 1.0+ (167): void. */
    OFPRAW_OFPT_ANOMALY_DETECTION_SI_TH,
};
...
enum ofptype {
    ...
    /*Added message for anomaly detection*/
    OFPTYPE_ANOMALY_DETECTION,          /* OFPRAW_OFPT_ANOMALY_DETECTION. */
    OFPTYPE_ANOMALY_DETECTION_O,       /* OFPRAW_OFPT_ANOMALY_DETECTION_O. */
    OFPTYPE_ANOMALY_DETECTION_T_O,      /* OFPRAW_OFPT_ANOMALY_DETECTION_T_O. */
    OFPTYPE_ANOMALY_DETECTION_T_T,      /* OFPRAW_OFPT_ANOMALY_DETECTION_T_T. */
    OFPTYPE_ANOMALY_DETECTION_TH_O,      /* OFPRAW_OFPT_ANOMALY_DETECTION_TH_O. */
    OFPTYPE_ANOMALY_DETECTION_TH_T,      /* OFPRAW_OFPT_ANOMALY_DETECTION_TH_T. */
    OFPTYPE_ANOMALY_DETECTION_FO_O,      /* OFPRAW_OFPT_ANOMALY_DETECTION_FO_O. */
    OFPTYPE_ANOMALY_DETECTION_FO_T,      /* OFPRAW_OFPT_ANOMALY_DETECTION_FO_T. */
    OFPTYPE_ANOMALY_DETECTION_FO_TH,      /* OFPRAW_OFPT_ANOMALY_DETECTION_FO_TH. */
    OFPTYPE_ANOMALY_DETECTION_FO_F,        /* OFPRAW_OFPT_ANOMALY_DETECTION_FO_F. */
    OFPTYPE_ANOMALY_DETECTION_FI_O,      /* OFPRAW_OFPT_ANOMALY_DETECTION_FI_O. */
    OFPTYPE_ANOMALY_DETECTION_FI_T,      /* OFPRAW_OFPT_ANOMALY_DETECTION_FI_T. */
    OFPTYPE_ANOMALY_DETECTION_FI_TH,    /* OFPRAW_OFPT_ANOMALY_DETECTION_FI_TH. */
    OFPTYPE_ANOMALY_DETECTION_SI_O,      /* OFPRAW_OFPT_ANOMALY_DETECTION_SI_O. */
    OFPTYPE_ANOMALY_DETECTION_SI_T,      /* OFPRAW_OFPT_ANOMALY_DETECTION_SI_T. */
    OFPTYPE_ANOMALY_DETECTION_SI_TH,      /* OFPRAW_OFPT_ANOMALY_DETECTION_SI_TH. */
};
