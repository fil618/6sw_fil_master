...
struct ofproto {
    ...
    /*self defined variable for anomaly detection*/
    int writing1;    /*check whether write to training file*/
    int writing1_p2;
    int training1;   /*in training time or not*/
    int training1_p2;
    float last_recorded_n_flow1;
    float last_recorded_n_flow1_p2;
    float last_recorded_n_bytes1;
    float last_recorded_n_bytes1_p2;
    float *traffic_arr1;  /*array store the traffic data for calculating lof*/
    float *traffic_arr1_p2;
    float *flow_arr1;     /*array store the flow data for calculating lof*/
    float *flow_arr1_p2;
    
    data_t *state1;  /*status of current (traffic,new flow)*/
    data_t *state1_p2;
    data_t *Data1[DATANUM]; /*store the LoOP of all training data*/
    data_t *Data1_p2[DATANUM];
    long last_time1;
    long last_time1_p2;
    int data_counter1;
    int data_counter1_p2;
   // float lof_status;
   float loOP_status1;
   float loOP_status1_p2;
   //data normalize
    float flow_mu1;
    float flow_mu1_p2;       
    float flow_sigma1;
    float flow_sigma1_p2;   
    float traffic_mu1;
    float traffic_mu1_p2;
    float traffic_sigma1;
    float traffic_sigma1_p2;
    ///////////////////////
    bool reported1;
    bool reported1_p2;
    //float lof_threshold;
    float loOP_threshold1;  //nguong cho LoOP
    float loOP_threshold1_p2;
    int k_thres1;
    int k_thres1_p2;
    int count_1;
    float sum_loop1;
    /*-----------ovs2--------------------*/
     int writing2;    /*check whether write to training file*/
     int writing2_p2; 
    int training2;   /*in training time or not*/
    int training2_p2; 
    float last_recorded_n_flow2;
    float last_recorded_n_flow2_p2;
    float last_recorded_n_bytes2;
    float last_recorded_n_bytes2_p2;
    float *traffic_arr2;  /*array store the traffic data for calculating lof*/
    float *traffic_arr2_p2;
    float *flow_arr2;     /*array store the flow data for calculating lof*/
    float *flow_arr2_p2;
    
    data_t *state2;  /*status of current (traffic,new flow)*/
    data_t *state2_p2;
    data_t *Data2[DATANUM]; /*store the LoOP of all training data*/
    data_t *Data2_p2[DATANUM];
    long last_time2;
    long last_time2_p2;
    int data_counter2;
    int data_counter2_p2;
   // float lof_status;
   float loOP_status2;
   float loOP_status2_p2;
   //data normalize
    float flow_mu2;      
    float flow_mu2_p2;   
    float flow_sigma2;
    float flow_sigma2_p2;   
    float traffic_mu2;
    float traffic_mu2_p2;
    float traffic_sigma2;
    float traffic_sigma2_p2;
    ///////////////////////
    bool reported2;
    bool reported2_p2;
    //float lof_threshold;
    float loOP_threshold2;  //nguong cho LoOP
    float loOP_threshold2_p2; 
    int k_thres2;
     int k_thres2_p2;
    float sum_loop2;
    /*---------------ovs3------------------*/
     int writing3;    /*check whether write to training file*/
     int writing3_p2; 
    int training3;   /*in training time or not*/
    int training3_p2;
    float last_recorded_n_flow3;
    float last_recorded_n_flow3_p2;
    float last_recorded_n_bytes3;
    float last_recorded_n_bytes3_p2;
    float *traffic_arr3;  /*array store the traffic data for calculating lof*/
    float *traffic_arr3_p2;
    float *flow_arr3;     /*array store the flow data for calculating lof*/
    float *flow_arr3_p2; 
    int count_3;
    int dem3;
    data_t *state3;  /*status of current (traffic,new flow)*/
    data_t *state3_p2; 
    data_t *Data3[DATANUM]; /*store the LoOP of all training data*/
     data_t *Data3_p2[DATANUM];
    long last_time3;
    long last_time3_p2;
    int data_counter3;
    int data_counter3_p2;
   // float lof_status;
   float loOP_status3;
   float loOP_status3_p2;
   //data normalize
    float flow_mu3;
    float flow_mu3_p2;       
    float flow_sigma3; 
    float flow_sigma3_p2;   
    float traffic_mu3;
    float traffic_mu3_p2;
    float traffic_sigma3;
    float traffic_sigma3_p2;
    ///////////////////////
    bool reported3;
    bool reported3_p2;
    //float lof_threshold;
    float loOP_threshold3;  //nguong cho LoOP
    float loOP_threshold3_p2;  
    int k_thres3;
    int k_thres3_p2;
    float sum_loop3;

    /*-------------------ovs4----------------*/
     int writing4;    /*check whether write to training file*/
     int writing4_p2;
     int writing4_p3;
     int writing4_p4;
    int training4;   /*in training time or not*/
    int training4_p2;
    int training4_p3;
    int training4_p4;
    float last_recorded_n_flow4;
    float last_recorded_n_flow4_p2;
    float last_recorded_n_flow4_p3;
    float last_recorded_n_flow4_p4;
    float last_recorded_n_bytes4;
    float last_recorded_n_bytes4_p2;
    float last_recorded_n_bytes4_p3;
    float last_recorded_n_bytes4_p4;
    float *traffic_arr4;  /*array store the traffic data for calculating lof*/
    float *traffic_arr4_p2;
    float *traffic_arr4_p3; 
    float *traffic_arr4_p4;   
    float *flow_arr4;     /*array store the flow data for calculating lof*/
    float *flow_arr4_p2;
    float *flow_arr4_p3;  
    float *flow_arr4_p4; 
    
    data_t *state4;  /*status of current (traffic,new flow)*/
    data_t *state4_p2;
    data_t *state4_p3;
    data_t *state4_p4;
    data_t *Data4[DATANUM]; /*store the LoOP of all training data*/
    data_t *Data4_p2[DATANUM];
    data_t *Data4_p3[DATANUM];
    data_t *Data4_p4[DATANUM];
    long last_time4;
    long last_time4_p2;
    long last_time4_p3;
    long last_time4_p4;
    int data_counter4;
    int data_counter4_p2;
    int data_counter4_p3;
    int data_counter4_p4;
   // float lof_status;
   float loOP_status4;
   float loOP_status4_p2;
   float loOP_status4_p3;
   float loOP_status4_p4;
   //data normalize
    float flow_mu4; 
    float flow_mu4_p2;
    float flow_mu4_p3; 
    float flow_mu4_p4;     
    float flow_sigma4; 
    float flow_sigma4_p2;
    float flow_sigma4_p3; 
    float flow_sigma4_p4;   
    float traffic_mu4;
    float traffic_mu4_p2;
    float traffic_mu4_p3;
    float traffic_mu4_p4;
    float traffic_sigma4;
    float traffic_sigma4_p2;
    float traffic_sigma4_p3;
    float traffic_sigma4_p4;
    ///////////////////////
    bool reported4;
    bool reported4_p2;
    bool reported4_p3;
    bool reported4_p4;
    //float lof_threshold;
    float loOP_threshold4;  //nguong cho LoOP
    float loOP_threshold4_p2;
    float loOP_threshold4_p3;
    float loOP_threshold4_p4;
    int k_thres4;
    int k_thres4_p2;
    int k_thres4_p3;
    int k_thres4_p4;
    float sum_loop4;
    /*-----------------------ovs5------------------*/
     int writing5;    /*check whether write to training file*/
     int writing5_p2;
     int writing5_p3;
    int training5;   /*in training time or not*/
    int training5_p2;  
    int training5_p3; 
    float last_recorded_n_flow5;
    float last_recorded_n_flow5_p2;
    float last_recorded_n_flow5_p3;
    float last_recorded_n_bytes5;
    float last_recorded_n_bytes5_p2;
    float last_recorded_n_bytes5_p3;
    float *traffic_arr5;  /*array store the traffic data for calculating lof*/
    float *traffic_arr5_p2;
    float *traffic_arr5_p3;
    float *flow_arr5;     /*array store the flow data for calculating lof*/
    float *flow_arr5_p2;
    float *flow_arr5_p3;  
    
    data_t *state5;  /*status of current (traffic,new flow)*/
    data_t *state5_p2;
    data_t *state5_p3; 
    data_t *Data5[DATANUM]; /*store the LoOP of all training data*/
    data_t *Data5_p2[DATANUM];
    data_t *Data5_p3[DATANUM];
    long last_time5;
    long last_time5_p2;
    long last_time5_p3;
    int data_counter5;
    int data_counter5_p2;
    int data_counter5_p3;
   // float lof_status;
   float loOP_status5;
   float loOP_status5_p2;
   float loOP_status5_p3;
   //data normalize
    float flow_mu5;
    float flow_mu5_p2; 
    float flow_mu5_p3;       
    float flow_sigma5;
    float flow_sigma5_p2;   
    float flow_sigma5_p3;   
    float traffic_mu5;
    float traffic_mu5_p2;
    float traffic_mu5_p3;
    float traffic_sigma5;
    float traffic_sigma5_p2;
    float traffic_sigma5_p3;
    ///////////////////////
    bool reported5;
    bool reported5_p2;
    bool reported5_p3;
    //float lof_threshold;
    float loOP_threshold5;  //nguong cho LoOP
    float loOP_threshold5_p2; 
    float loOP_threshold5_p3; 
    int k_thres5;
    int k_thres5_p2;
    int k_thres5_p3;
    float sum_loop5;
    ...
    /*-------------ovs6---------------*/
     int writing6;    /*check whether write to training file*/
     int writing6_p2;
     int writing6_p3;
    int training6;   /*in training time or not*/
    int training6_p2;
    int training6_p3;
    float last_recorded_n_flow6;
    float last_recorded_n_flow6_p2;
    float last_recorded_n_flow6_p3;
    float last_recorded_n_bytes6;
    float last_recorded_n_bytes6_p2;
    float last_recorded_n_bytes6_p3;
    float *traffic_arr6;  /*array store the traffic data for calculating lof*/
    float *traffic_arr6_p2; 
    float *traffic_arr6_p3; 
    float *flow_arr6;     /*array store the flow data for calculating lof*/
    float *flow_arr6_p2;
    float *flow_arr6_p3;  
    
    data_t *state6;  /*status of current (traffic,new flow)*/
    data_t *state6_p2;
    data_t *state6_p3;  
    data_t *Data6[DATANUM]; /*store the LoOP of all training data*/
    data_t *Data6_p2[DATANUM];
    data_t *Data6_p3[DATANUM];
    long last_time6;
    long last_time6_p2;
    long last_time6_p3;
    int data_counter6;
    int data_counter6_p2;
    int data_counter6_p3;
   // float lof_status;
   float loOP_status6;
   float loOP_status6_p2;
   float loOP_status6_p3;
   //data normalize
    float flow_mu6;
    float flow_mu6_p2;
    float flow_mu6_p3;       
    float flow_sigma6; 
    float flow_sigma6_p2;
    float flow_sigma6_p3;    
    float traffic_mu6;
    float traffic_mu6_p2;
    float traffic_mu6_p3;
    float traffic_sigma6;
    float traffic_sigma6_p2;
    float traffic_sigma6_p3;
    ///////////////////////
    bool reported6;
    bool reported6_p2;
    bool reported6_p3;
    //float lof_threshold;
    float loOP_threshold6;  //nguong cho LoOP
    float loOP_threshold6_p2;
    float loOP_threshold6_p3;
    int k_thres6;
    int k_thres6_p2;
    int k_thres6_p3;
    float sum_loop6;
