...
///////////////////////
int count_packet_in_port1=0;
int count_packet_in_port2=0;
int count_packet_in2_port1=0;
int count_packet_in2_port2=0;
int count_packet_in3_port1=0;
int count_packet_in3_port2=0;
int count_packet_in4_port1=0;
int count_packet_in4_port2=0;
int count_packet_in4_port3=0;
int count_packet_in4_port4=0;
int count_packet_in5_port1=0;
int count_packet_in5_port2=0;
int count_packet_in5_port3=0;
int count_packet_in6_port1=0;
int count_packet_in6_port2=0;
int count_packet_in6_port3=0;
int packet_count=0;
///////////////////////
...
void connmgr_send_anomaly_detection(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update1_p1.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection(protocol);
        ofpbuf_put(msg,convert(value1_1),n);
        ofconn_send(ofconn, msg, NULL);
    }
    // fclose(fp1);
}
void connmgr_send_anomaly_detection_p2(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update1_p2.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection_p2(protocol);
        ofpbuf_put(msg,convert(value1_2),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}
void connmgr_send_anomaly_detection2_p1(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update2_p1.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection2_p1(protocol);
        ofpbuf_put(msg,convert(value2_1),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}
void connmgr_send_anomaly_detection2_p2(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update2_p2.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
         size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection2_p2(protocol);
        ofpbuf_put(msg,convert(value2_2),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection3_p1(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update3_p1.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection3_p1(protocol);
        ofpbuf_put(msg,convert(value3_1),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection3_p2(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update3_p2.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection3_p2(protocol);
        ofpbuf_put(msg,convert(value3_2),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection4_p1(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update4_p1.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection4_p1(protocol);
        ofpbuf_put(msg,convert(value4_1),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection4_p2(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update4_p2.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection4_p2(protocol);
        ofpbuf_put(msg,convert(value4_2),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection4_p3(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update4_p3.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection4_p3(protocol);
        ofpbuf_put(msg,convert(value4_3),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection4_p4(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update4_p3.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection4_p4(protocol);
        ofpbuf_put(msg,convert(value4_4),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection5_p1(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update5_p1.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection5_p1(protocol);
        ofpbuf_put(msg,convert(value5_1),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection5_p2(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update5_p2.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection5_p2(protocol);
        ofpbuf_put(msg,convert(value5_2),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection5_p3(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update5_p2.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection5_p3(protocol);
        ofpbuf_put(msg,convert(value5_3),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection6_p1(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update6_p1.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection6_p1(protocol);
        ofpbuf_put(msg,convert(value6_1),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection6_p2(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update6_p2.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection6_p2(protocol);
        ofpbuf_put(msg,convert(value6_2),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}

void connmgr_send_anomaly_detection6_p3(struct connmgr *mgr)
{
    struct ofconn *ofconn;
    // FILE *fp1;
    // fp1= fopen("/home/lctuan/result_LoOP/update6_p3.log","r");
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns)
    {
        size_t n = 8;
        enum ofputil_protocol protocol = ofconn_get_protocol(ofconn);
        struct ofpbuf *msg = ofputil_encode_anomaly_detection6_p3(protocol);
        ofpbuf_put(msg,convert(value6_3),n);
        ofconn_send(ofconn,msg,NULL);
    }
    // fclose(fp1);
}
                       ...
                       const struct ofproto_async_msg *am)
{
    ...
    LIST_FOR_EACH (ofconn, connmgr_node, &mgr->conns) {
        ...
        if(is_miss)
        {
            ...
            {
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 1)
                {
                    count_packet_in_port1 ++;
                    // count_packet_in4_port1 ++;
                    // count_packet_in6_port2 ++;
                }

                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 2)
                {
                    count_packet_in_port2 ++;
                    // count_packet_in6_port1 ++;
                    // count_packet_in4_port3 ++;
                }
            }
            else if (mgr->ofproto->datapath_id == 0000000000000002 )
            {
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 1)
                {
                    count_packet_in2_port1 ++;
                    // count_packet_in4_port2 ++;
                    // count_packet_in6_port2 ++;
                }
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 2)
                {
                    count_packet_in2_port2 ++;
                    // count_packet_in4_port3 ++;
                    // count_packet_in6_port1 ++;
                }
            }
            else if (mgr->ofproto->datapath_id == 0000000000000003 )
            {
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 1)
                {
                    count_packet_in3_port1 ++;
                    // count_packet_in5_port1 ++;
                    // count_packet_in6_port3 ++;
                }
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 2)
                {
                    count_packet_in3_port2 ++;
                    // count_packet_in6_port1 ++;
                    // count_packet_in5_port2 ++;
                }
                }
            else if (mgr->ofproto->datapath_id == 0000000000000004 )
            {
        //       FILE *f;
        //  f = fopen("home/fil02/OvS-LoOP/control_path.log","a+");
        //  fprintf(f,"%ld,%d\n",mgr->ofproto->datapath_id,am->pin.up.base.flow_metadata.flow.in_port.ofp_port);
        //  fclose(f);  
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 1)
                {
                    count_packet_in4_port1 ++;
                ...
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 2)
                    count_packet_in4_port2 ++;
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 3)
                    count_packet_in4_port3 ++;
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 4)
                    count_packet_in4_port4 ++;
                }
            else if (mgr->ofproto->datapath_id == 0000000000000005)
            {
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 1)
                    count_packet_in5_port1 ++;
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 2)
                    count_packet_in5_port2 ++;
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 3)
                    count_packet_in5_port3 ++;
            }
            else if (mgr->ofproto->datapath_id == 0000000000000006 )
            {
                if (am->pin.up.base.flow_metadata.flow.in_port.ofp_port == 1)
                {
                    count_packet_in6_port1 ++;
...
{
     count_packet_in_port1=0;
     count_packet_in_port2=0;
     count_packet_in2_port1=0;
     count_packet_in2_port2=0;
     count_packet_in3_port1=0;
     count_packet_in3_port2=0;
     count_packet_in4_port1=0;
     count_packet_in4_port2=0;
     count_packet_in4_port3=0;
     count_packet_in4_port4=0;
     count_packet_in5_port1=0;
     count_packet_in5_port2=0;
     count_packet_in5_port3=0;
     count_packet_in6_port1=0;
     count_packet_in6_port2=0;
     count_packet_in6_port3=0;
}
int get_packet_in_counter_port1(void)
{
    return count_packet_in_port1;
}
int get_packet_in_counter_port2(void)
{
    return count_packet_in_port2;
}
int get_packet_in_counter_2_port1(void)
{
    return count_packet_in2_port1;
}
int get_packet_in_counter_2_port2(void)
{
    return count_packet_in2_port2;
}
int get_packet_in_counter_3_port1(void)
{
    return count_packet_in3_port1;
}
int get_packet_in_counter_3_port2(void)
{
    return count_packet_in3_port2;
}
int get_packet_in_counter_4_port1(void)
{
    return count_packet_in4_port1;
}
int get_packet_in_counter_4_port2(void)
{
    return count_packet_in4_port2;
}
int get_packet_in_counter_4_port3(void)
{
    return count_packet_in4_port3;
}
int get_packet_in_counter_4_port4(void)
{
    return count_packet_in4_port4;
}
int get_packet_in_counter_5_port1(void)
{
    return count_packet_in5_port1;
}
int get_packet_in_counter_5_port2(void)
{
    return count_packet_in5_port2;
}
int get_packet_in_counter_5_port3(void)
{
    return count_packet_in5_port3;
}
int get_packet_in_counter_6_port1(void)
{
    return count_packet_in6_port1;
}
int get_packet_in_counter_6_port2(void)
{
    return count_packet_in6_port2;
}
int get_packet_in_counter_6_port3(void)
{
    return count_packet_in6_port3;
}
