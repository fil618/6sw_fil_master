...
//changes in ofproto_create and ofproto_run
#include<stdio.h>
#include<time.h>
#include<math.h>
//#include"lof.h"
    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    *ofprotop = NULL;
    ...
    /*Init variable for anomaly detection*/
    //////khoi tao ban dau
    // /*----------ovs1------------------------*/
    // if (kt == true)
    // {
    ...
    ofproto->training1=1;
    ofproto->training1_p2=1;
    ofproto->writing1=1;  //nguyen ban writing =0;
    ofproto->writing1_p2=1;
    ofproto->k_thres1=0;
    ofproto->k_thres1_p2=0;
    ofproto->last_recorded_n_bytes1=0;
    ofproto->last_recorded_n_bytes1_p2=0;
    ofproto->last_recorded_n_flow1=0;
    ofproto->last_recorded_n_flow1_p2=0;
    ofproto->data_counter1=0;
    ofproto->data_counter1_p2=0;
    ofproto->sum_loop1=0;
    ofproto->last_time1=time(NULL);
    ofproto->last_time1_p2=time(NULL);
    ofproto->state1=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state1_p2=(data_t *)malloc(sizeof(data_t)); 
    ofproto->traffic_arr1=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr1_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr1=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr1_p2 = (float*)malloc(DATANUM*sizeof(float));
    for (i=0;i<DATANUM;i++)
    {
        ofproto->Data1[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data1_p2[i]=(data_t *)malloc(sizeof(data_t));
    }  
    ofproto->reported1=false;
    ofproto->reported1_p2=false;
    //ofproto->lof_threshold=0;
    ofproto->loOP_threshold1=0;
    ofproto->loOP_threshold1_p2=0;
    ofproto->count_1 =0;
     /*----------ovs2------------------------*/
    ofproto->training2=21;
    ofproto->training2_p2=21;
    ofproto->writing2=1;
    ofproto->writing2_p2=1;
    ofproto->k_thres2=0;
    ofproto->k_thres2_p2=0;
    ofproto->last_recorded_n_bytes2=0;
    ofproto->last_recorded_n_bytes2_p2=0;
    ofproto->last_recorded_n_flow2=0;
    ofproto->last_recorded_n_flow2_p2=0;
    ofproto->data_counter2=0;
    ofproto->data_counter2_p2=0;
    ofproto->sum_loop2=0;
    ofproto->last_time2=time(NULL);
    ofproto->last_time2_p2=time(NULL);
    ofproto->state2=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state2_p2=(data_t *)malloc(sizeof(data_t)); 
    ofproto->traffic_arr2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr2_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr2_p2=(float *)malloc(DATANUM*sizeof(float));
    for (i=0;i<DATANUM;i++)
    {
        ofproto->Data2[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data2_p2[i]=(data_t *)malloc(sizeof(data_t));
    }  
    ofproto->reported2=false;
    ofproto->reported2_p2=false;
    //ofproto->lof_threshold=0;
    ofproto->loOP_threshold2=0;
    ofproto->loOP_threshold2_p2=0;
     /*----------ovs3------------------------*/
    //  if (kt1 == true)
    //  {
    ofproto->training3=31;
    ofproto->training3_p2=31;
    ofproto->writing3=1;
    ofproto->writing3_p2=1;
    //     co_unt++;
    //     if (co_unt == 2)
    //     {
    //         kt1 = false;
    ...
    //  }
    ofproto->k_thres3=0;
    ofproto->k_thres3_p2=0;
    ofproto->last_recorded_n_bytes3=0;
    ofproto->last_recorded_n_bytes3_p2=0;
    ofproto->last_recorded_n_flow3=0;
    ofproto->last_recorded_n_flow3_p2=0;
    ofproto->data_counter3=0;
    ofproto->data_counter3_p2=0;
    ofproto->sum_loop3=0;
    ofproto->last_time3=time(NULL);
    ofproto->last_time3_p2=time(NULL);
    ofproto->state3=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state3_p2=(data_t *)malloc(sizeof(data_t)); 
    ofproto->traffic_arr3=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr3_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr3=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr3_p2=(float *)malloc(DATANUM*sizeof(float));
    for (i=0;i<DATANUM;i++)
    {
        ofproto->Data3[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data3_p2[i]=(data_t *)malloc(sizeof(data_t));
    }  
    ofproto->reported3=false;
    ofproto->reported3_p2=false;
    //ofproto->lof_threshold=0;
    ofproto->loOP_threshold3=0;
    ofproto->loOP_threshold3_p2=0;
    ofproto->count_3 =0;
     /*----------ovs4------------------------*/
    ofproto->training4=41;
    ofproto->training4_p2=41;
    ofproto->training4_p3=41;
    ofproto->training4_p4=41;
    ofproto->writing4=1;
    ofproto->writing4_p2=1;
    ofproto->writing4_p3=1;
    ofproto->writing4_p4=1;
    ofproto->k_thres4=0;
    ofproto->k_thres4_p2=0;
    ofproto->k_thres4_p3=0;
     ofproto->k_thres4_p4=0;
    ofproto->last_recorded_n_bytes4=0;
    ofproto->last_recorded_n_bytes4_p2=0;
    ofproto->last_recorded_n_bytes4_p3=0;
    ofproto->last_recorded_n_bytes4_p4=0;
    ofproto->last_recorded_n_flow4=0;
    ofproto->last_recorded_n_flow4_p2=0;
    ofproto->last_recorded_n_flow4_p3=0;
    ofproto->last_recorded_n_flow4_p4=0;
    ofproto->data_counter4=0;
    ofproto->data_counter4_p2=0;
    ofproto->data_counter4_p3=0;
    ofproto->data_counter4_p4=0;
    ofproto->sum_loop4=0;
    ofproto->last_time4=time(NULL);
    ofproto->last_time4_p2=time(NULL);
    ofproto->last_time4_p3=time(NULL);
    ofproto->last_time4_p4=time(NULL);
    ofproto->state4=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state4_p2=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state4_p3=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state4_p4=(data_t *)malloc(sizeof(data_t)); 
    ofproto->traffic_arr4=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr4_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr4_p3=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr4_p4=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr4=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr4_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr4_p3=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr4_p4=(float *)malloc(DATANUM*sizeof(float));
    for (i=0;i<DATANUM;i++)
    {
        ofproto->Data4[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data4_p2[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data4_p3[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data4_p4[i]=(data_t *)malloc(sizeof(data_t));
    }  
    ofproto->reported4=false;
    ofproto->reported4_p2=false;
    ofproto->reported4_p3=false;
    ofproto->reported4_p4=false;
    //ofproto->lof_threshold=0;
    ofproto->loOP_threshold4=0;
    ofproto->loOP_threshold4_p2=0;
    ofproto->loOP_threshold4_p3=0;
    ofproto->loOP_threshold4_p4=0;
     /*----------ovs5------------------------*/
    ofproto->training5=51;
    ofproto->training5_p2=51;
    ofproto->training5_p3=51;
    ofproto->writing5=1;
    ofproto->writing5_p2=1;
    ofproto->writing5_p3=1;
    ofproto->k_thres5=0;
    ofproto->k_thres5_p2=0;
    ofproto->k_thres5_p3=0;
    ofproto->last_recorded_n_bytes5=0;
    ofproto->last_recorded_n_bytes5_p2=0;
    ofproto->last_recorded_n_bytes5_p3=0;
    ofproto->last_recorded_n_flow5=0;
    ofproto->last_recorded_n_flow5_p2=0;
    ofproto->last_recorded_n_flow5_p3=0;
    ofproto->data_counter5=0;
    ofproto->data_counter5_p2=0;
    ofproto->data_counter5_p3=0;
    ofproto->sum_loop5=0;
    ofproto->last_time5=time(NULL);
    ofproto->last_time5_p2=time(NULL);
    ofproto->last_time5_p3=time(NULL);
    ofproto->state5=(data_t *)malloc(sizeof(data_t)); 
      ofproto->state5_p2=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state5_p3=(data_t *)malloc(sizeof(data_t));
    ofproto->traffic_arr5=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr5_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr5_p3=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr5=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr5_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr5_p3=(float *)malloc(DATANUM*sizeof(float));
    for (i=0;i<DATANUM;i++)
    {
        ofproto->Data5[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data5_p2[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data5_p3[i]=(data_t *)malloc(sizeof(data_t));
    }  
    ofproto->reported5=false;
    ofproto->reported5_p2=false;
    ofproto->reported5_p3=false;
    //ofproto->lof_threshold=0;
    ofproto->loOP_threshold5=0;
    ofproto->loOP_threshold5_p2=0;
    ofproto->loOP_threshold5_p3=0;
     /*----------ovs6------------------------*/
    ofproto->training6=61;
    ofproto->training6_p2=61;
    ofproto->training6_p3=61;
    ofproto->writing6=1;
    ofproto->writing6_p2=1;
    ofproto->writing6_p3=1;
    ofproto->k_thres6=0;
    ofproto->k_thres6_p2=0;
    ofproto->k_thres6_p3=0;
    ofproto->last_recorded_n_bytes6=0;
    ofproto->last_recorded_n_bytes6_p2=0;
    ofproto->last_recorded_n_bytes6_p3=0;
    ofproto->last_recorded_n_flow6=0;
    ofproto->last_recorded_n_flow6_p2=0;
    ofproto->last_recorded_n_flow6_p3=0;
    ofproto->data_counter6=0;
    ofproto->data_counter6_p2=0;
    ofproto->data_counter6_p3=0;
    ofproto->sum_loop6=0;
    ofproto->last_time6=time(NULL);
    ofproto->last_time6_p2=time(NULL);
    ofproto->last_time6_p3=time(NULL);
    ofproto->state6=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state6_p2=(data_t *)malloc(sizeof(data_t)); 
    ofproto->state6_p3=(data_t *)malloc(sizeof(data_t)); 
    ofproto->traffic_arr6=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr6_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->traffic_arr6_p3=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr6=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr6_p2=(float *)malloc(DATANUM*sizeof(float));
    ofproto->flow_arr6_p3=(float *)malloc(DATANUM*sizeof(float));
    for (i=0;i<DATANUM;i++)
    {
        ofproto->Data6[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data6_p2[i]=(data_t *)malloc(sizeof(data_t));
        ofproto->Data6_p3[i]=(data_t *)malloc(sizeof(data_t));
    }  
    ofproto->reported6=false;
    ofproto->reported6_p2=false;
    ofproto->reported6_p3=false;
    //ofproto->lof_threshold=0;
    ofproto->loOP_threshold6=0;
    ofproto->loOP_threshold6_p2=0;
    ofproto->loOP_threshold6_p3=0;
    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    /*----------ovs1-------------*/
    free(ofproto->state1);
    free(ofproto->state1_p2);
    free(ofproto->traffic_arr1);
    free(ofproto->traffic_arr1_p2);
    free(ofproto->flow_arr1);
    free(ofproto->flow_arr1_p2);
    for (int i=0;i<DATANUM;i++)
    {
        free(ofproto->Data1[i]);
        free(ofproto->Data1_p2[i]);
    } 
    /*----------ovs2-------------*/
    free(ofproto->state2);
    free(ofproto->state2_p2);
    free(ofproto->traffic_arr2);
    free(ofproto->traffic_arr2_p2);
    free(ofproto->flow_arr2);
    free(ofproto->flow_arr2_p2);
    for (int i=0;i<DATANUM;i++)
    {
        free(ofproto->Data2[i]);
        free(ofproto->Data2_p2[i]);
    } 
     /*----------ovs3-------------*/
     free(ofproto->state3);
     free(ofproto->state3_p2);
    free(ofproto->traffic_arr3);
    free(ofproto->traffic_arr3_p2);
    free(ofproto->flow_arr3);
    free(ofproto->flow_arr3_p2);
    for (int i=0;i<DATANUM;i++)
    {
        free(ofproto->Data3[i]);
        free(ofproto->Data3_p2[i]);
    } 
    /*----------ovs4-------------*/
     free(ofproto->state4);
     free(ofproto->state4_p2);
     free(ofproto->state4_p3);
     free(ofproto->state4_p4);
    free(ofproto->traffic_arr4);
    free(ofproto->traffic_arr4_p2);
    free(ofproto->traffic_arr4_p3);
     free(ofproto->traffic_arr4_p4);
    free(ofproto->flow_arr4);
    free(ofproto->flow_arr4_p2);
    free(ofproto->flow_arr4_p3);
    free(ofproto->flow_arr4_p4);
    for (int i=0;i<DATANUM;i++)
    {
        free(ofproto->Data4[i]);
        free(ofproto->Data4_p2[i]);
        free(ofproto->Data4_p3[i]);
        free(ofproto->Data4_p4[i]);
    } 
    /*----------ovs5-------------*/
     free(ofproto->state5);
     free(ofproto->state5_p2);
     free(ofproto->state5_p3);
    free(ofproto->traffic_arr5);
    free(ofproto->traffic_arr5_p2);
    free(ofproto->traffic_arr5_p3);
    free(ofproto->flow_arr5);
    free(ofproto->flow_arr5_p2);
    free(ofproto->flow_arr5_p3);
    for (int i=0;i<DATANUM;i++)
    {
        free(ofproto->Data5[i]);
        free(ofproto->Data5_p2[i]);
        free(ofproto->Data5_p3[i]);
    }
    /*----------ovs6-------------*/
     free(ofproto->state6);
     free(ofproto->state6_p2);
     free(ofproto->state6_p3);
    free(ofproto->traffic_arr6);
    free(ofproto->traffic_arr6_p2);
    free(ofproto->traffic_arr6_p3);
    free(ofproto->flow_arr6);
    free(ofproto->flow_arr6_p2);
    free(ofproto->flow_arr6_p3);
    for (int i=0;i<DATANUM;i++)
    {
        free(ofproto->Data6[i]);
        free(ofproto->Data6_p2[i]);
        free(ofproto->Data6_p3[i]);
    }  
    /**/
    free(ofproto->name);
    free(ofproto->type);
...
///////////////////////////////////
void abnormal_detect1(struct ofproto *p)
{
    struct timeval start1,start1_p2,end1,end1_p2;
    float current_traf1,current_traf1_p2,current_flow1,current_flow1_p2;
  


    long now_recorded_n_flow1;
    long now_recorded_n_flow1_p2;
    uint64_t now_recorded_n_bytes1;
    uint64_t now_recorded_n_bytes1_p2;
    ...
    {  
      ...
      struct ofport *port1;
      port1 = ofproto_get_port(p,PORT);
      struct ofputil_port_stats ops1 = { .port_no = port1->pp.port_no };
      ofproto_port_get_stats(port1, &ops1.stats);
      now_recorded_n_bytes1=ops1.stats.rx_bytes;
      now_recorded_n_flow1=get_packet_in_counter_port1();

      struct ofport *port1_p2;
      port1_p2 = ofproto_get_port(p,PORT_2);
      struct ofputil_port_stats ops1_p2 = { .port_no = port1_p2->pp.port_no };
      ofproto_port_get_stats(port1_p2, &ops1_p2.stats);
    ...
    //   fclose(fp1);
     ...
     {    
        ...
        // if (p->data_counter1 < DATANUM && p->writing1 ==1)
        ...
        { 
          p->data_counter1=DATANUM;  
          p->training1=0;
          gettimeofday(&start1,NULL);          
        //   while(p->data_counter1<DATANUM)
        //   //for (int i=0;i<DATANUM;i++)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val1 = fscanf(fp1,"%f,%f",&p->flow_arr1[p->data_counter1],&p->traffic_arr1[p->data_counter1]);
        //     p->data_counter1++;
        //     if (ret_val1 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp1);        
          p->traffic_mu1=calc_mu(p->traffic_arr1,p->data_counter1);
          p->traffic_sigma1=calc_sigma(p->traffic_arr1,p->data_counter1);
          p->flow_mu1=calc_mu(p->flow_arr1,p->data_counter1);
          p->flow_sigma1=calc_sigma(p->flow_arr1,p->data_counter1);  
          for (int i=0;i<p->data_counter1;i++)
          { 
            p->Data1[i]->traffic_norm=normalize(p->traffic_arr1[i],p->traffic_mu1,p->traffic_sigma1);
            p->Data1[i]->n_flow_norm=normalize(p->flow_arr1[i],p->flow_mu1,p->flow_sigma1);
          }
        ...
        //   fp1= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug1.log","a+");
          for(int i=0;i<p->data_counter1;i++)
          {
           ...
           if (!(p->Data1[i]->LoOP >= 0  && p->Data1[i]->LoOP <= 1))
                p->Data1[i]->LoOP = 0;
        //    fprintf(fp1,"%f,%f,%f\n",p->Data1[i]->traffic_norm,p->Data1[i]->n_flow_norm,p->Data1[i]->LoOP);
           temp1 = 1.0*p->Data1[i]->LoOP;
            if((p->loOP_threshold1<temp1) && (temp1 >= 0) && (temp1 < 1))
               p->loOP_threshold1=temp1;
          }
      ...
      else 
      {
         ...
         make_NN_udate(p->state1,p->Data1,p->data_counter1);
         p->loOP_status1 = LoOP_udate(p->state1,p->Data1);
      ...
      p->last_recorded_n_bytes1=(double)now_recorded_n_bytes1;
      p->last_recorded_n_flow1=now_recorded_n_flow1;
...
///////////////port2////////////////////////////////////////////
     ...
     {    
        ...
        /*start calculating*/
        else if (p->writing1_p2 ==0)
        { 
          p->data_counter1_p2=DATANUM;  
          p->training1_p2=0;
          gettimeofday(&start1_p2,NULL);          
        //   while(p->data_counter1_p2<DATANUM)
        //   //for (int i=0;i<DATANUM;i++)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val1 = fscanf(fp1,"%f,%f",&p->flow_arr1_p2[p->data_counter1_p2],&p->traffic_arr1_p2[p->data_counter1_p2]);
        //     p->data_counter1_p2++;
        //     if (ret_val1 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp1);        
          p->traffic_mu1_p2=calc_mu(p->traffic_arr1_p2,p->data_counter1_p2);
          p->traffic_sigma1_p2=calc_sigma(p->traffic_arr1_p2,p->data_counter1_p2);
          p->flow_mu1_p2=calc_mu(p->flow_arr1_p2,p->data_counter1_p2);
          p->flow_sigma1_p2=calc_sigma(p->flow_arr1_p2,p->data_counter1_p2);  
          for (int i=0;i<p->data_counter1_p2;i++)
          { 
            p->Data1_p2[i]->traffic_norm=normalize(p->traffic_arr1_p2[i],p->traffic_mu1_p2,p->traffic_sigma1_p2);
        ...
        //   fp1= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug1_p2.log","a+");
          for(int i=0;i<p->data_counter1_p2;i++)
          {
           ...
           if (!(p->Data1_p2[i]->LoOP >= 0  && p->Data1_p2[i]->LoOP <= 1))
                p->Data1_p2[i]->LoOP = 0;
        //    fprintf(fp1,"%f,%f,%f\n",p->Data1_p2[i]->traffic_norm,p->Data1_p2[i]->n_flow_norm,p->Data1_p2[i]->LoOP);
           temp1 = 1.0*p->Data1_p2[i]->LoOP;
            if((p->loOP_threshold1_p2<temp1) && (temp1 >= 0) && (temp1 < 1))
               p->loOP_threshold1_p2=temp1;
          }
      ...
      else 
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state1_p2,p->Data1_p2,p->data_counter1_p2);
         p->loOP_status1_p2 = LoOP_udate(p->state1_p2,p->Data1_p2);
      ...
      p->last_recorded_n_bytes1_p2=(double)now_recorded_n_bytes1_p2;
      p->last_recorded_n_flow1_p2=now_recorded_n_flow1_p2;
      p->last_time1=current_time1;  
    }

}

//////////////ovs2//////////////////////
void abnormal_detect2(struct ofproto *p)
{
    struct timeval start2,start2_p2,end2,end2_p2;
    float current_traf2,current_traf2_p2,current_flow2,current_flow2_p2;
 


    long now_recorded_n_flow2;
    long now_recorded_n_flow2_p2;
    uint64_t now_recorded_n_bytes2;
    uint64_t now_recorded_n_bytes2_p2;


    time_t current_time2=time(NULL);
    FILE *fp2;
    
    if(current_time2 - p->last_time2>=CYCLE)
    {  
      
      struct ofport *port2;
      port2 = ofproto_get_port(p,PORT);  //PORT
      struct ofputil_port_stats ops2 = { .port_no = port2->pp.port_no };
      ofproto_port_get_stats(port2, &ops2.stats);
      now_recorded_n_bytes2=ops2.stats.rx_bytes;
      now_recorded_n_flow2=get_packet_in_counter_2_port1();
      
      struct ofport *port2_p2;
      port2_p2 = ofproto_get_port(p,PORT_2);  //PORT
      struct ofputil_port_stats ops2_p2 = { .port_no = port2_p2->pp.port_no };
      ofproto_port_get_stats(port2_p2, &ops2_p2.stats);
      now_recorded_n_bytes2_p2=ops2_p2.stats.rx_bytes;
      now_recorded_n_flow2_p2=get_packet_in_counter_2_port2();
    ...
    //   fclose(fp2);
     ...
     {    
        ...
        // if (p->data_counter2 < DATANUM && p->writing2 ==1)
        ...
        /*start calculating*/
        else if (p->writing2 == 2)   
        { 
            p->data_counter2=DATANUM;
          p->training2=2;
          gettimeofday(&start2,NULL);          
        //   while(p->data_counter2<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val2 = fscanf(fp2,"%f,%f",&p->flow_arr2[p->data_counter2],&p->traffic_arr2[p->data_counter2]);
        //     p->data_counter2++;
        //     if (ret_val2 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp2);              
          p->traffic_mu2=calc_mu(p->traffic_arr2,p->data_counter2);
          p->traffic_sigma2=calc_sigma(p->traffic_arr2,p->data_counter2);
          p->flow_mu2=calc_mu(p->flow_arr2,p->data_counter2);
          p->flow_sigma2=calc_sigma(p->flow_arr2,p->data_counter2);
                  
          for (int i=0;i<p->data_counter2;i++)
          { 
            p->Data2[i]->traffic_norm=normalize(p->traffic_arr2[i],p->traffic_mu2,p->traffic_sigma2);
            p->Data2[i]->n_flow_norm=normalize(p->flow_arr2[i],p->flow_mu2,p->flow_sigma2);
          }
        ...
        //   fp2= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug2.log","a+");
          for(int i=0;i<p->data_counter2;i++)
          {
           ...
           p->Data2[i]->LoOP = LoOP(p->Data2[i],p->Data2);
           if (!(p->Data2[i]->LoOP >= 0  && p->Data2[i]->LoOP <= 1))
                p->Data2[i]->LoOP = 0;
        //    fprintf(fp2,"%f,%f,%f\n",p->Data2[i]->traffic_norm,p->Data2[i]->n_flow_norm,p->Data2[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp2 = 1.0*p->Data2[i]->LoOP;
            if((p->loOP_threshold2<temp2) && (temp2 >= 0) && (temp2 < 1))
               p->loOP_threshold2=temp2;
            //    else 
      ...
      else if (p->training2 ==2)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state2,p->Data2,p->data_counter2);
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2);
      ...
      p->last_recorded_n_bytes2=(double)now_recorded_n_bytes2;
      p->last_recorded_n_flow2=now_recorded_n_flow2;
 ...
 /*--------------------port2 ------------------------------------------*/
     ...
     {    
        ...
        //   if exists , move to calculating*/
        // //if(fp2==NULL || p->writing2 == 1)
        // if (p->data_counter2_p2 < DATANUM && p->writing2_p2 ==1)
        ...
        /*start calculating*/
        else if (p->writing2_p2 == 2)   
        { 
            p->data_counter2_p2=DATANUM;
          p->training2_p2=2;
          gettimeofday(&start2_p2,NULL);          
        //   while(p->data_counter2_p2<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val2 = fscanf(fp2,"%f,%f",&p->flow_arr2_p2[p->data_counter2_p2],&p->traffic_arr2_p2[p->data_counter2_p2]);
        //     p->data_counter2_p2++;
        //     if (ret_val2 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp2);              
          p->traffic_mu2_p2=calc_mu(p->traffic_arr2_p2,p->data_counter2_p2);
        ...
        //     fclose(fp2);
          ...
          { 
            p->Data2_p2[i]->traffic_norm=normalize(p->traffic_arr2_p2[i],p->traffic_mu2_p2,p->traffic_sigma2_p2);
            p->Data2_p2[i]->n_flow_norm=normalize(p->flow_arr2_p2[i],p->flow_mu2_p2,p->flow_sigma2_p2);
          }
        ...
        //   fp2= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug2_p2.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data2_p2[i]->LoOP = LoOP(p->Data2_p2[i],p->Data2_p2);
           if (!(p->Data2_p2[i]->LoOP >=0 && p->Data2_p2[i]->LoOP <= 1))
                p->Data2_p2[i]->LoOP = 0;
        //    fprintf(fp2,"%f,%f,%f\n",p->Data2_p2[i]->traffic_norm,p->Data2_p2[i]->n_flow_norm,p->Data2_p2[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp2 = 1.0*p->Data2_p2[i]->LoOP;
            if((p->loOP_threshold2_p2<temp2) && (temp2 >= 0) && (temp2 < 1))
               p->loOP_threshold2_p2=temp2;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      p->last_recorded_n_bytes2_p2=(double)now_recorded_n_bytes2_p2;
      p->last_recorded_n_flow2_p2=now_recorded_n_flow2_p2;
      p->last_time2=current_time2;  
    }
}
/*-------------------------ovs3-------------*/
void abnormal_detect3(struct ofproto *p)
{
    struct timeval start3,start3_p2,end3,end3_p2;
    float current_traf3,current_traf3_p2,current_flow3,current_flow3_p2;
    //int count;


    long now_recorded_n_flow3;
    long now_recorded_n_flow3_p2;
    uint64_t now_recorded_n_bytes3;
    uint64_t now_recorded_n_bytes3_p2;


    time_t current_time3=time(NULL);
    FILE *fp3;
    
    if(current_time3 - p->last_time3>=CYCLE)
    {  
      //trigger_send_anomaly_detection(p);  
      //get traffic through port PORT and number of new flow
      struct ofport *port3;
      port3 = ofproto_get_port(p,PORT);
      struct ofputil_port_stats ops3 = { .port_no = port3->pp.port_no };
      ofproto_port_get_stats(port3, &ops3.stats);

      now_recorded_n_bytes3=ops3.stats.rx_bytes;
      now_recorded_n_flow3=get_packet_in_counter_3_port1();

      struct ofport *port3_p2;
      port3_p2 = ofproto_get_port(p,PORT_2);
      struct ofputil_port_stats ops3_p2 = { .port_no = port3_p2->pp.port_no };
      ofproto_port_get_stats(port3_p2, &ops3_p2.stats);

      now_recorded_n_bytes3_p2=ops3_p2.stats.rx_bytes;
      now_recorded_n_flow3_p2=get_packet_in_counter_3_port2();
    ...
    //   fclose(fp3);
     ...
     {    
        ...
        // if (p->data_counter3 < DATANUM && p->writing3 ==1)
        ...
        /*start calculating*/
        else if (p->writing3 ==3)
        { 
            p->data_counter3 =DATANUM;
          p->training3=3;
          gettimeofday(&start3,NULL);      
        //   while(p->data_counter3<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val3 = fscanf(fp3,"%f,%f",&p->flow_arr3[p->data_counter3],&p->traffic_arr3[p->data_counter3]);
        //     p->data_counter3++;
        //     if (ret_val3 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp3);              
          p->traffic_mu3=calc_mu(p->traffic_arr3,p->data_counter3);
          p->traffic_sigma3=calc_sigma(p->traffic_arr3,p->data_counter3);
          p->flow_mu3=calc_mu(p->flow_arr3,p->data_counter3);
          p->flow_sigma3=calc_sigma(p->flow_arr3,p->data_counter3);
                  
          for (int i=0;i<p->data_counter3;i++)
          { 
            p->Data3[i]->traffic_norm=normalize(p->traffic_arr3[i],p->traffic_mu3,p->traffic_sigma3);
            p->Data3[i]->n_flow_norm=normalize(p->flow_arr3[i],p->flow_mu3,p->flow_sigma3);
          }
        ...
        //   fp3= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug3.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data3[i]->LoOP = LoOP(p->Data3[i],p->Data3);
           if (!(p->Data3[i]->LoOP >=0  && p->Data3[i]->LoOP <= 1))
                p->Data3[i]->LoOP = 0;
        //    fprintf(fp3,"%f,%f,%f\n",p->Data3[i]->traffic_norm,p->Data3[i]->n_flow_norm,p->Data3[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp3 = 1.0*p->Data3[i]->LoOP;
            if((p->loOP_threshold3<temp3) && (temp3 >= 0) && (temp3 < 1))
               p->loOP_threshold3=temp3;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if(p->training3 == 3)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state3,p->Data3,p->data_counter3);
         p->loOP_status3 = LoOP_udate(p->state3,p->Data3);
...
/*-------------------port2-----------------------*/
     ...
     {    
        ...
        //   if exists , move to calculating*/
        // //if(fp3==NULL || p->writing3 == 1)
        // if (p->data_counter3_p2 < DATANUM && p->writing3_p2 ==1)
        ...
        /*start calculating*/
        else if (p->writing3_p2 ==3)
        { 
            p->data_counter3_p2 = DATANUM;
          p->training3_p2 = 3;
          gettimeofday(&start3_p2,NULL);      
        //   while(p->data_counter3_p2<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val3 = fscanf(fp3,"%f,%f",&p->flow_arr3_p2[p->data_counter3_p2],&p->traffic_arr3_p2[p->data_counter3_p2]);
        //     p->data_counter3_p2++;
        //     if (ret_val3 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp3);              
          p->traffic_mu3_p2=calc_mu(p->traffic_arr3_p2,p->data_counter3_p2);
          p->traffic_sigma3_p2=calc_sigma(p->traffic_arr3_p2,p->data_counter3_p2);
          p->flow_mu3_p2=calc_mu(p->flow_arr3_p2,p->data_counter3_p2);
          p->flow_sigma3_p2=calc_sigma(p->flow_arr3_p2,p->data_counter3_p2);
                  
          for (int i=0;i<p->data_counter3_p2;i++)
          { 
            p->Data3_p2[i]->traffic_norm=normalize(p->traffic_arr3_p2[i],p->traffic_mu3_p2,p->traffic_sigma3_p2);
            p->Data3_p2[i]->n_flow_norm=normalize(p->flow_arr3_p2[i],p->flow_mu3_p2,p->flow_sigma3_p2);
          }
        ...
        //   fp3= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug3_p2.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data3_p2[i]->LoOP = LoOP(p->Data3_p2[i],p->Data3_p2);
           if (!(p->Data3_p2[i]->LoOP >=0 && p->Data3_p2[i]->LoOP <= 1))
                p->Data3_p2[i]->LoOP = 0;
        //    fprintf(fp3,"%f,%f,%f\n",p->Data3_p2[i]->traffic_norm,p->Data3_p2[i]->n_flow_norm,p->Data3_p2[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp3_p2 = 1.0*p->Data3_p2[i]->LoOP;
            if((p->loOP_threshold3_p2<temp3_p2) && (temp3_p2 >= 0) && (temp3_p2 < 1))
               p->loOP_threshold3_p2=temp3_p2;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if(p->training3_p2 == 3)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state3_p2,p->Data3_p2,p->data_counter3_p2);
         p->loOP_status3_p2 = LoOP_udate(p->state3_p2,p->Data3_p2);
      ...
      p->last_recorded_n_bytes3_p2=(double)now_recorded_n_bytes3_p2;
      p->last_recorded_n_flow3_p2=now_recorded_n_flow3_p2;
      p->last_time3=current_time3;  
    }
}
/*-----------------ovs4--------------------*/
void abnormal_detect4(struct ofproto *p)
{
    struct timeval start4,start4_p2,start4_p3,end4,end4_p2,end4_p3, start4_p4, end4_p4;
    float current_traf4,current_traf4_p2,current_traf4_p3,current_flow4,current_flow4_p2,current_flow4_p3;
    float current_traf4_p4, current_flow4_p4;



    long now_recorded_n_flow4;
    long now_recorded_n_flow4_p2;
    long now_recorded_n_flow4_p3;
    long now_recorded_n_flow4_p4;
    uint64_t now_recorded_n_bytes4;
    uint64_t now_recorded_n_bytes4_p2;
    uint64_t now_recorded_n_bytes4_p3;
    uint64_t now_recorded_n_bytes4_p4;


    time_t current_time4=time(NULL);
    FILE *fp4;
    
    if(current_time4 - p->last_time4>=CYCLE)
    {  
      //trigger_send_anomaly_detection(p);  
      //get traffic through port PORT and number of new flow
      struct ofport *port4;
      port4 = ofproto_get_port(p,PORT);
      struct ofputil_port_stats ops4 = { .port_no = port4->pp.port_no };
      ofproto_port_get_stats(port4, &ops4.stats);
      now_recorded_n_bytes4=ops4.stats.rx_bytes;
      now_recorded_n_flow4=get_packet_in_counter_4_port1();

      //////////////////////
      struct ofport *port4_p2;
      port4_p2 = ofproto_get_port(p,PORT_2);
      struct ofputil_port_stats ops4_p2 = { .port_no = port4_p2->pp.port_no };
      ofproto_port_get_stats(port4_p2, &ops4_p2.stats);
      now_recorded_n_bytes4_p2 = ops4_p2.stats.rx_bytes;
      now_recorded_n_flow4_p2 = get_packet_in_counter_4_port2();
      ////////////////////////////////////////////////////
        struct ofport *port4_p3;
      port4_p3 = ofproto_get_port(p,PORT_3);
      struct ofputil_port_stats ops4_p3 = { .port_no = port4_p3->pp.port_no };
      ofproto_port_get_stats(port4_p3, &ops4_p3.stats);
      now_recorded_n_bytes4_p3 = ops4_p3.stats.rx_bytes;
      now_recorded_n_flow4_p3 = get_packet_in_counter_4_port3();

    ////////////////////////////////////////////////////////////////
        struct ofport *port4_p4;
      port4_p4 = ofproto_get_port(p,PORT_4);
      struct ofputil_port_stats ops4_p4 = { .port_no = port4_p4->pp.port_no };
      ofproto_port_get_stats(port4_p4, &ops4_p4.stats);
      now_recorded_n_bytes4_p4 = ops4_p4.stats.rx_bytes;
      now_recorded_n_flow4_p4 = get_packet_in_counter_4_port4();
      ///////////////////////////////////////////////////////////
      current_flow4 = ((float)(now_recorded_n_flow4 - p->last_recorded_n_flow4))/CYCLE;
      current_traf4 = abs(((double)now_recorded_n_bytes4 - p->last_recorded_n_bytes4))/CYCLE;

      current_flow4_p2 = ((float)(now_recorded_n_flow4_p2 - p->last_recorded_n_flow4_p2))/CYCLE;
      current_traf4_p2 = abs(((double)now_recorded_n_bytes4_p2 - p->last_recorded_n_bytes4_p2))/CYCLE;

      current_flow4_p3 = ((float)(now_recorded_n_flow4_p3 - p->last_recorded_n_flow4_p3))/CYCLE;
      current_traf4_p3 = abs(((double)now_recorded_n_bytes4_p3 - p->last_recorded_n_bytes4_p3))/CYCLE;
    ...
    //   fclose(fp4);
     ...
     {    
        ...
        // if (p->data_counter4 < DATANUM && p->writing4 ==1)
        ...
        /*start calculating*/
        else if (p->writing4 == 4)
        { 
            p->data_counter4=DATANUM;
          p->training4=4;
          gettimeofday(&start4,NULL);          
        //   while(p->data_counter4<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val4 = fscanf(fp4,"%f,%f",&p->flow_arr4[p->data_counter4],&p->traffic_arr4[p->data_counter4]);
        //     p->data_counter4++;
        //     if (ret_val4 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp4);              
          p->traffic_mu4=calc_mu(p->traffic_arr4,p->data_counter4);
          p->traffic_sigma4=calc_sigma(p->traffic_arr4,p->data_counter4);
          p->flow_mu4=calc_mu(p->flow_arr4,p->data_counter4);
          p->flow_sigma4=calc_sigma(p->flow_arr4,p->data_counter4);
                  
          for (int i=0;i<p->data_counter4;i++)
          { 
            p->Data4[i]->traffic_norm=normalize(p->traffic_arr4[i],p->traffic_mu4,p->traffic_sigma4);
            p->Data4[i]->n_flow_norm=normalize(p->flow_arr4[i],p->flow_mu4,p->flow_sigma4);
          }
                
          //lrd(p->Data,p->data_counter);
            //PLOF(p->Data,p->data_counter);
        ...
        //   fp4= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug4.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data4[i]->LoOP = LoOP(p->Data4[i],p->Data4);
           if (!(p->Data4[i]->LoOP >=0 && p->Data4[i]->LoOP <= 1))
                p->Data4[i]->LoOP = 0;
        //    fprintf(fp4,"%f,%f,%f\n",p->Data4[i]->traffic_norm,p->Data4[i]->n_flow_norm,p->Data4[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp4 = 1.0*p->Data4[i]->LoOP;
            if((p->loOP_threshold4<temp4) && (temp4 >= 0) && (temp4 < 1))
               p->loOP_threshold4=temp4;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if (p->training4 == 4)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state4,p->Data4,p->data_counter4);
         p->loOP_status4 = LoOP_udate(p->state4,p->Data4);
	...
	trigger_send_anomaly_detection4_p1(p);
      ...
      p->last_recorded_n_bytes4=(double)now_recorded_n_bytes4;
      p->last_recorded_n_flow4=now_recorded_n_flow4;
     ...
     {    
        ...
        /*start calculating*/
        else if (p->writing4_p2 == 4)
        { 
            p->data_counter4_p2 = DATANUM;
          p->training4_p2 = 4;
          gettimeofday(&start4_p2, NULL);          
        //   while(p->data_counter4_p2 < DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val4 = fscanf(fp4,"%f,%f",&p->flow_arr4_p2[p->data_counter4_p2],&p->traffic_arr4_p2[p->data_counter4_p2]);
        //     p->data_counter4_p2++;
        //     if (ret_val4 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp4);              
          p->traffic_mu4_p2 = calc_mu(p->traffic_arr4_p2, p->data_counter4_p2);
          p->traffic_sigma4_p2 = calc_sigma(p->traffic_arr4_p2, p->data_counter4_p2);
          p->flow_mu4_p2 = calc_mu(p->flow_arr4_p2, p->data_counter4_p2);
          p->flow_sigma4_p2 = calc_sigma(p->flow_arr4_p2, p->data_counter4_p2);
                  
          for (int i=0;i<p->data_counter4_p2;i++)
          { 
            p->Data4_p2[i]->traffic_norm=normalize(p->traffic_arr4_p2[i],p->traffic_mu4_p2,p->traffic_sigma4_p2);
            p->Data4_p2[i]->n_flow_norm=normalize(p->flow_arr4_p2[i],p->flow_mu4_p2,p->flow_sigma4_p2);
          }
        ...
        //   fp4= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug4_p2.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data4_p2[i]->LoOP = LoOP(p->Data4_p2[i],p->Data4_p2);
            if (!(p->Data4_p2[i]->LoOP >=0 && p->Data4_p2[i]->LoOP <= 1))
                p->Data4_p2[i]->LoOP = 0;
        //    fprintf(fp4,"%f,%f,%f\n",p->Data4_p2[i]->traffic_norm,p->Data4_p2[i]->n_flow_norm,p->Data4_p2[i]->LoOP);
           temp4_p2 = 1.0*p->Data4_p2[i]->LoOP;
            if((p->loOP_threshold4_p2 < temp4_p2) && (temp4_p2 >= 0) && (temp4_p2 < 1))
               p->loOP_threshold4_p2 = temp4_p2;
          }
      ...
      else if (p->training4_p2 == 4)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state4_p2,p->Data4_p2,p->data_counter4_p2);
         p->loOP_status4_p2 = LoOP_udate(p->state4_p2, p->Data4_p2);
      ...
      p->last_recorded_n_bytes4_p2 = (double)now_recorded_n_bytes4_p2;
      p->last_recorded_n_flow4_p2 = now_recorded_n_flow4_p2;
     ...
     {    
        ...
        /*start calculating*/
        else if (p->writing4_p3 == 4)
        { 
            p->data_counter4_p3 = DATANUM;
          p->training4_p3 = 4;
          gettimeofday(&start4_p3, NULL);          
        //   while(p->data_counter4_p3 < DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val4 = fscanf(fp4,"%f,%f",&p->flow_arr4_p3[p->data_counter4_p3],&p->traffic_arr4_p3[p->data_counter4_p3]);
        //     p->data_counter4_p3++;
        //     if (ret_val4 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp4);              
          p->traffic_mu4_p3 = calc_mu(p->traffic_arr4_p3, p->data_counter4_p3);
          p->traffic_sigma4_p3 = calc_sigma(p->traffic_arr4_p3, p->data_counter4_p3);
          p->flow_mu4_p3 = calc_mu(p->flow_arr4_p3, p->data_counter4_p3);
          p->flow_sigma4_p3 = calc_sigma(p->flow_arr4_p3, p->data_counter4_p3);
                  
          for (int i=0;i<p->data_counter4_p3;i++)
          { 
            p->Data4_p3[i]->traffic_norm=normalize(p->traffic_arr4_p3[i],p->traffic_mu4_p3,p->traffic_sigma4_p3);
            p->Data4_p3[i]->n_flow_norm=normalize(p->flow_arr4_p3[i],p->flow_mu4_p3,p->flow_sigma4_p3);
          }
        ...
        //   fp4= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug4_p3.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data4_p3[i]->LoOP = LoOP(p->Data4_p3[i],p->Data4_p3);
           if (!(p->Data4_p3[i]->LoOP >=0 && p->Data4_p3[i]->LoOP <= 1))
                p->Data4_p3[i]->LoOP = 0;
        //    fprintf(fp4,"%f,%f,%f\n",p->Data4_p3[i]->traffic_norm,p->Data4_p3[i]->n_flow_norm,p->Data4_p3[i]->LoOP);
           temp4_p3 = 1.0*p->Data4_p3[i]->LoOP;
            if((p->loOP_threshold4_p3 < temp4_p3) && (temp4_p3 >= 0) && (temp4_p3 < 1))
               p->loOP_threshold4_p3 = temp4_p3;
          }
      ...
      else if (p->training4_p3 == 4)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state4_p3,p->Data4_p3,p->data_counter4_p3);
         p->loOP_status4_p3 = LoOP_udate(p->state4_p3, p->Data4_p3);
	...
	trigger_send_anomaly_detection4_p3(p);
      ...
      p->last_recorded_n_bytes4_p3 = (double)now_recorded_n_bytes4_p3;
      p->last_recorded_n_flow4_p3 = now_recorded_n_flow4_p3;


    /******************************port4*************************************/
       if(p->training4_p4==41)
     {    
        ...
        /*start calculating*/
        else if (p->writing4_p4 == 4)
        { 
            p->data_counter4_p4 = DATANUM;
          p->training4_p4 = 4;
          gettimeofday(&start4_p4, NULL);          
        //   while(p->data_counter4_p4 < DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val4 = fscanf(fp4,"%f,%f",&p->flow_arr4_p4[p->data_counter4_p4],&p->traffic_arr4_p4[p->data_counter4_p4]);
        //     p->data_counter4_p4++;
        //     if (ret_val4 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp4);              
          p->traffic_mu4_p4 = calc_mu(p->traffic_arr4_p4, p->data_counter4_p4);
          p->traffic_sigma4_p4 = calc_sigma(p->traffic_arr4_p4, p->data_counter4_p4);
          p->flow_mu4_p4 = calc_mu(p->flow_arr4_p4, p->data_counter4_p4);
          p->flow_sigma4_p4 = calc_sigma(p->flow_arr4_p4, p->data_counter4_p4);
                  
          for (int i=0;i<p->data_counter4_p4;i++)
          { 
            p->Data4_p4[i]->traffic_norm=normalize(p->traffic_arr4_p4[i],p->traffic_mu4_p4,p->traffic_sigma4_p4);
            p->Data4_p4[i]->n_flow_norm=normalize(p->flow_arr4_p4[i],p->flow_mu4_p4,p->flow_sigma4_p4);
          }
        ...
        //   fp4= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug4_p4.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data4_p4[i]->LoOP = LoOP(p->Data4_p4[i],p->Data4_p4);
           if (!(p->Data4_p4[i]->LoOP >=0 && p->Data4_p4[i]->LoOP <= 1))
                p->Data4_p4[i]->LoOP = 0;
        //    fprintf(fp4,"%f,%f,%f\n",p->Data4_p4[i]->traffic_norm,p->Data4_p4[i]->n_flow_norm,p->Data4_p4[i]->LoOP);
           temp4_p4 = 1.0*p->Data4_p4[i]->LoOP;
            if((p->loOP_threshold4_p4 < temp4_p4) && (temp4_p4 >= 0) && (temp4_p4 < 1))
               p->loOP_threshold4_p4 = temp4_p4;
          }
      ...
      //if not in training, predict
      else if (p->training4_p4 == 4)
      {
          if ((current_flow4_p4 !=0 && current_traf4_p4 !=0))
          //if (!(current_flow4_p4 <=0 && current_traf4_p4 <=0))  //phần fix thêm
          {
          p->state4_p4->traffic_norm=normalize(current_traf4_p4,p->traffic_mu4_p4,p->traffic_sigma4_p4);
          p->state4_p4->n_flow_norm=normalize(current_flow4_p4,p->flow_mu4_p4,p->flow_sigma4_p4);
          
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state4_p4,p->Data4_p4,p->data_counter4_p4);
         p->loOP_status4_p4 = LoOP_udate(p->state4_p4, p->Data4_p4);
	...
	trigger_send_anomaly_detection4_p4(p);
      ...
      p->last_recorded_n_bytes4_p4 = (double)now_recorded_n_bytes4_p4;
      p->last_recorded_n_flow4_p4 = now_recorded_n_flow4_p4;
      p->last_time4=current_time4;  
    }
}
/*--------------------ovs5--------------------*/
void abnormal_detect5(struct ofproto *p)
{
    struct timeval start5, start5_p2, end5, end5_p2, start5_p3, end5_p3;
    float current_traf5, current_traf5_p2, current_flow5, current_flow5_p2;
    float current_traf5_p3, current_flow5_p3;



    long now_recorded_n_flow5;
    long now_recorded_n_flow5_p2;
    long now_recorded_n_flow5_p3;
    uint64_t now_recorded_n_bytes5;
    uint64_t now_recorded_n_bytes5_p2;
    uint64_t now_recorded_n_bytes5_p3;


    time_t current_time5=time(NULL);
    FILE *fp5;
    
    if(current_time5 - p->last_time5>=CYCLE)
    {  
      //trigger_send_anomaly_detection(p);  
      //get traffic through port PORT and number of new flow
      struct ofport *port5;
      port5 = ofproto_get_port(p,PORT);
      struct ofputil_port_stats ops5 = { .port_no = port5->pp.port_no };
      ofproto_port_get_stats(port5, &ops5.stats);
      now_recorded_n_bytes5=ops5.stats.rx_bytes;
      now_recorded_n_flow5=get_packet_in_counter_5_port1();
      /*-----------port2--------------------*/
      struct ofport *port5_p2;
      port5_p2 = ofproto_get_port(p,PORT_2);
      struct ofputil_port_stats ops5_p2 = { .port_no = port5_p2->pp.port_no };
      ofproto_port_get_stats(port5_p2, &ops5_p2.stats);
      now_recorded_n_bytes5_p2 = ops5_p2.stats.rx_bytes;
      now_recorded_n_flow5_p2=get_packet_in_counter_5_port2();

      /************port2*********************/
      struct ofport *port5_p3;
      port5_p3 = ofproto_get_port(p,PORT_3);
      struct ofputil_port_stats ops5_p3 = { .port_no = port5_p3->pp.port_no };
      ofproto_port_get_stats(port5_p3, &ops5_p3.stats);
      now_recorded_n_bytes5_p3 = ops5_p3.stats.rx_bytes;
      now_recorded_n_flow5_p3=get_packet_in_counter_5_port3();
      ////////////////////////////////////////////
      current_flow5=((float)(now_recorded_n_flow5-p->last_recorded_n_flow5))/CYCLE;
      current_traf5=abs(((double)now_recorded_n_bytes5-p->last_recorded_n_bytes5))/CYCLE;

      current_flow5_p2 = ((float)(now_recorded_n_flow5_p2 - p->last_recorded_n_flow5_p2))/CYCLE;
      current_traf5_p2 = abs(((double)now_recorded_n_bytes5_p2 - p->last_recorded_n_bytes5_p2))/CYCLE;
    ...
    //   fclose(fp5);
     ...
     {    
        ...
        // if (p->data_counter5 < DATANUM && p->writing5 ==1)
        ...
        /*start calculating*/
        else if (p->writing5 == 5)
        { 
            p->data_counter5=DATANUM;
          p->training5=5;
          gettimeofday(&start5,NULL);          
        //   while(p->data_counter5<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val5 = fscanf(fp5,"%f,%f",&p->flow_arr5[p->data_counter5],&p->traffic_arr5[p->data_counter5]);
        //     p->data_counter5++;
        //     if (ret_val5 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp5);              
          p->traffic_mu5=calc_mu(p->traffic_arr5,p->data_counter5);
          p->traffic_sigma5=calc_sigma(p->traffic_arr5,p->data_counter5);
          p->flow_mu5=calc_mu(p->flow_arr5,p->data_counter5);
          p->flow_sigma5=calc_sigma(p->flow_arr5,p->data_counter5);
                  
          for (int i=0;i<p->data_counter5;i++)
          { 
            p->Data5[i]->traffic_norm=normalize(p->traffic_arr5[i],p->traffic_mu5,p->traffic_sigma5);
            p->Data5[i]->n_flow_norm=normalize(p->flow_arr5[i],p->flow_mu5,p->flow_sigma5);
          }
        ...
        //   fp5= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug5.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data5[i]->LoOP = LoOP(p->Data5[i],p->Data5);
           if (!(p->Data5[i]->LoOP >=0 && p->Data5[i]->LoOP <= 1))
                p->Data5[i]->LoOP = 0;
        //    fprintf(fp5,"%f,%f,%f\n",p->Data5[i]->traffic_norm,p->Data5[i]->n_flow_norm,p->Data5[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp5 = 1.0*p->Data5[i]->LoOP;
            if((p->loOP_threshold5<temp5) && (temp5 >= 0) && (temp5 < 1))
               p->loOP_threshold5=temp5;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if (p->training5 == 5)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state5,p->Data5,p->data_counter5);
         p->loOP_status5 = LoOP_udate(p->state5,p->Data5);
	...
	trigger_send_anomaly_detection5_p1(p);
      ...
      p->last_recorded_n_bytes5=(double)now_recorded_n_bytes5;
      p->last_recorded_n_flow5=now_recorded_n_flow5;
     ...
     {    
        ...
        // if (p->data_counter5_p2 < DATANUM && p->writing5_p2 ==1)
        ...
        /*start calculating*/
        else if (p->writing5_p2 == 5)
        { 
            p->data_counter5_p2=DATANUM;
          p->training5_p2=5;
          gettimeofday(&start5_p2,NULL);          
        //   while(p->data_counter5_p2<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val5 = fscanf(fp5,"%f,%f",&p->flow_arr5_p2[p->data_counter5_p2],&p->traffic_arr5_p2[p->data_counter5_p2]);
        //     p->data_counter5_p2++;
        //     if (ret_val5 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp5);              
          p->traffic_mu5_p2=calc_mu(p->traffic_arr5_p2,p->data_counter5_p2);
          p->traffic_sigma5_p2=calc_sigma(p->traffic_arr5_p2,p->data_counter5_p2);
          p->flow_mu5_p2=calc_mu(p->flow_arr5_p2,p->data_counter5_p2);
          p->flow_sigma5_p2=calc_sigma(p->flow_arr5_p2,p->data_counter5_p2);
                  
          for (int i=0;i<p->data_counter5_p2;i++)
          { 
            p->Data5_p2[i]->traffic_norm=normalize(p->traffic_arr5_p2[i],p->traffic_mu5_p2,p->traffic_sigma5_p2);
            p->Data5_p2[i]->n_flow_norm=normalize(p->flow_arr5_p2[i],p->flow_mu5_p2,p->flow_sigma5_p2);
          }
        ...
        //   fp5= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug5_p2.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data5_p2[i]->LoOP = LoOP(p->Data5_p2[i],p->Data5_p2);
           if (!(p->Data5_p2[i]->LoOP >=0 && p->Data5_p2[i]->LoOP <= 1))
                p->Data5_p2[i]->LoOP = 0;
        //    fprintf(fp5,"%f,%f,%f\n",p->Data5_p2[i]->traffic_norm,p->Data5_p2[i]->n_flow_norm,p->Data5_p2[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp5_p2 = 1.0*p->Data5_p2[i]->LoOP;
            if((p->loOP_threshold5_p2<temp5_p2) && (temp5_p2 >= 0) && (temp5_p2 < 1))
               p->loOP_threshold5_p2=temp5_p2;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if (p->training5_p2 == 5)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state5_p2,p->Data5_p2,p->data_counter5_p2);
         p->loOP_status5_p2 = LoOP_udate(p->state5_p2,p->Data5_p2);
      ...
      p->last_recorded_n_bytes5_p2=(double)now_recorded_n_bytes5_p2;
      p->last_recorded_n_flow5_p2=now_recorded_n_flow5_p2;
    ...
    /*******************port3*************************/
     ...
     {    
        ...
        // if (p->data_counter5_p3 < DATANUM && p->writing5_p3 ==1)
        ...
        /*start calculating*/
        else if (p->writing5_p3 == 5)
        { 
            p->data_counter5_p3=DATANUM;
          p->training5_p3=5;
          gettimeofday(&start5_p3,NULL);          
        //   while(p->data_counter5_p3<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val5 = fscanf(fp5,"%f,%f",&p->flow_arr5_p3[p->data_counter5_p3],&p->traffic_arr5_p3[p->data_counter5_p3]);
        //     p->data_counter5_p3++;
        //     if (ret_val5 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp5);              
          p->traffic_mu5_p3=calc_mu(p->traffic_arr5_p3,p->data_counter5_p3);
          p->traffic_sigma5_p3=calc_sigma(p->traffic_arr5_p3,p->data_counter5_p3);
          p->flow_mu5_p3=calc_mu(p->flow_arr5_p3,p->data_counter5_p3);
          p->flow_sigma5_p3=calc_sigma(p->flow_arr5_p3,p->data_counter5_p3);
                  
          for (int i=0;i<p->data_counter5_p3;i++)
          { 
            p->Data5_p3[i]->traffic_norm=normalize(p->traffic_arr5_p3[i],p->traffic_mu5_p3,p->traffic_sigma5_p3);
            p->Data5_p3[i]->n_flow_norm=normalize(p->flow_arr5_p3[i],p->flow_mu5_p3,p->flow_sigma5_p3);
          }
        ...
        //   fp5= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug5_p3.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data5_p3[i]->LoOP = LoOP(p->Data5_p3[i],p->Data5_p3);
           if (!(p->Data5_p3[i]->LoOP >=0 && p->Data5_p3[i]->LoOP <= 1))
                p->Data5_p3[i]->LoOP = 0;
        //    fprintf(fp5,"%f,%f,%f\n",p->Data5_p3[i]->traffic_norm,p->Data5_p3[i]->n_flow_norm,p->Data5_p3[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp5_p3 = 1.0*p->Data5_p3[i]->LoOP;
            if((p->loOP_threshold5_p3<temp5_p3) && (temp5_p3 >= 0) && (temp5_p3 < 1))
               p->loOP_threshold5_p3=temp5_p3;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      //if not in training, predict
      else if (p->training5_p3 == 5)
      {
          gettimeofday(&start5_p3, NULL);
          if (current_traf5_p3 != 0 && current_flow5_p3 != 0)
          //if (!(current_flow5_p3 <=0 && current_traf5_p3 <=0))  //phần fix thêm
          {
          p->state5_p3->traffic_norm=normalize(current_traf5_p3,p->traffic_mu5_p3,p->traffic_sigma5_p3);
          p->state5_p3->n_flow_norm=normalize(current_flow5_p3,p->flow_mu5_p3,p->flow_sigma5_p3);
          
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state5_p3,p->Data5_p3,p->data_counter5_p3);
         p->loOP_status5_p3 = LoOP_udate(p->state5_p3,p->Data5_p3);
      ...
      p->last_recorded_n_bytes5_p3=(double)now_recorded_n_bytes5_p3;
      p->last_recorded_n_flow5_p3=now_recorded_n_flow5_p3;
      p->last_time5=current_time5;  
    }
}
/*--------------ovs6-----------------------*/
void abnormal_detect6(struct ofproto *p)
{
    struct timeval start6, start6_p2, start6_p3, end6, end6_p2, end6_p3;
    float current_traf6, current_traf6_p2, current_traf6_p3, current_flow6, current_flow6_p2, current_flow6_p3;



    long now_recorded_n_flow6;
    long now_recorded_n_flow6_p2;
    long now_recorded_n_flow6_p3;
    uint64_t now_recorded_n_bytes6;
    uint64_t now_recorded_n_bytes6_p2;
    uint64_t now_recorded_n_bytes6_p3;


    time_t current_time6=time(NULL);
    FILE *fp6;
    
    if(current_time6 - p->last_time6>=CYCLE)
    {  
      //trigger_send_anomaly_detection(p);  
      //get traffic through port PORT and number of new flow
      struct ofport *port6;
      port6 = ofproto_get_port(p,PORT);
      struct ofputil_port_stats ops6 = { .port_no = port6->pp.port_no };
      ofproto_port_get_stats(port6, &ops6.stats);
      now_recorded_n_bytes6=ops6.stats.rx_bytes;
      now_recorded_n_flow6=get_packet_in_counter_6_port1();

        /*------------port2---------------*/
      struct ofport *port6_p2;
      port6_p2 = ofproto_get_port(p,PORT_2);
      struct ofputil_port_stats ops6_p2 = { .port_no = port6_p2->pp.port_no };
      ofproto_port_get_stats(port6_p2, &ops6_p2.stats);
      now_recorded_n_bytes6_p2 = ops6_p2.stats.rx_bytes;
      now_recorded_n_flow6_p2 = get_packet_in_counter_6_port2();

      /*-------------port3-----------------*/
      struct ofport *port6_p3;
      port6_p3 = ofproto_get_port(p,PORT_3);
      struct ofputil_port_stats ops6_p3 = { .port_no = port6_p3->pp.port_no };
      ofproto_port_get_stats(port6_p3, &ops6_p3.stats);
      now_recorded_n_bytes6_p3 = ops6_p3.stats.rx_bytes;
      now_recorded_n_flow6_p3 = get_packet_in_counter_6_port3();

      current_flow6=((float)(now_recorded_n_flow6-p->last_recorded_n_flow6))/CYCLE;
      current_traf6=abs(((double)now_recorded_n_bytes6-p->last_recorded_n_bytes6))/CYCLE;

      current_flow6_p2 = ((float)(now_recorded_n_flow6_p2 - p->last_recorded_n_flow6_p2))/CYCLE;
      current_traf6_p2 = abs(((double)now_recorded_n_bytes6_p2 - p->last_recorded_n_bytes6_p2))/CYCLE;
    ...
    //   fclose(fp6);
     ...
     {    
        ...
        // if (p->data_counter6 < DATANUM && p->writing6 ==1)
        ...
        /*start calculating*/
        else if (p->writing6 == 6)
        { 
            p->data_counter6=DATANUM;
          p->training6=6;
          gettimeofday(&start6,NULL);          
        //   while(p->data_counter6<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val6 = fscanf(fp6,"%f,%f",&p->flow_arr6[p->data_counter6],&p->traffic_arr6[p->data_counter6]);
        //     p->data_counter6++;
        //     if (ret_val6 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp6);              
          p->traffic_mu6=calc_mu(p->traffic_arr6,p->data_counter6);
          p->traffic_sigma6=calc_sigma(p->traffic_arr6,p->data_counter6);
          p->flow_mu6=calc_mu(p->flow_arr6,p->data_counter6);
          p->flow_sigma6=calc_sigma(p->flow_arr6,p->data_counter6);
                  
          for (int i=0;i<p->data_counter6;i++)
          { 
            p->Data6[i]->traffic_norm=normalize(p->traffic_arr6[i],p->traffic_mu6,p->traffic_sigma6);
            p->Data6[i]->n_flow_norm=normalize(p->flow_arr6[i],p->flow_mu6,p->flow_sigma6);
          }
        ...
        //   fp6= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug6.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data6[i]->LoOP = LoOP(p->Data6[i],p->Data6);
           if (!(p->Data6[i]->LoOP >=0 && p->Data6[i]->LoOP <= 1))
                p->Data6[i]->LoOP = 0;
        //    fprintf(fp6,"%f,%f,%f\n",p->Data6[i]->traffic_norm,p->Data6[i]->n_flow_norm,p->Data6[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp6 = 1.0*p->Data6[i]->LoOP;
            if((p->loOP_threshold6<temp6) && (temp6 >= 0) && (temp6 < 1))
               p->loOP_threshold6=temp6;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if (p->training6 == 6)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state6,p->Data6,p->data_counter6);
         p->loOP_status6 = LoOP_udate(p->state6,p->Data6);
        if (!(p->loOP_status6 >=0 && p->loOP_status6 <= 1))
                p->loOP_status6 = 0;
            value6_1 = p->loOP_status6;
	trigger_send_amomaly_detection6_p1(p);
          if (p->loOP_status6 > p->loOP_threshold6 && p->reported6 == false)
              {
                  p->k_thres6++;
                  if (p->k_thres6 >= 10)
                  {
      ...
      p->last_recorded_n_bytes6=(double)now_recorded_n_bytes6;
      p->last_recorded_n_flow6=now_recorded_n_flow6;
     ...
     {    
        ...
        // if (p->data_counter6_p2 < DATANUM && p->writing6_p2 ==1)
        ...
        /*start calculating*/
        else if (p->writing6_p2 == 6)
        { 
            p->data_counter6_p2=DATANUM;
          p->training6_p2=6;
          gettimeofday(&start6_p2,NULL);          
        //   while(p->data_counter6_p2<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val6 = fscanf(fp6,"%f,%f",&p->flow_arr6_p2[p->data_counter6_p2],&p->traffic_arr6_p2[p->data_counter6_p2]);
        //     p->data_counter6_p2++;
        //     if (ret_val6 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp6);              
          p->traffic_mu6_p2=calc_mu(p->traffic_arr6_p2,p->data_counter6_p2);
          p->traffic_sigma6_p2=calc_sigma(p->traffic_arr6_p2,p->data_counter6_p2);
          p->flow_mu6_p2=calc_mu(p->flow_arr6_p2,p->data_counter6_p2);
          p->flow_sigma6_p2=calc_sigma(p->flow_arr6_p2,p->data_counter6_p2);
                  
          for (int i=0;i<p->data_counter6_p2;i++)
          { 
            p->Data6_p2[i]->traffic_norm=normalize(p->traffic_arr6_p2[i],p->traffic_mu6_p2,p->traffic_sigma6_p2);
            p->Data6_p2[i]->n_flow_norm=normalize(p->flow_arr6_p2[i],p->flow_mu6_p2,p->flow_sigma6_p2);
          }
        ...
        //   fp6= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug6_p2.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data6_p2[i]->LoOP = LoOP(p->Data6_p2[i],p->Data6_p2);
           if (!(p->Data6_p2[i]->LoOP >=0 && p->Data6_p2[i]->LoOP <= 1))
                p->Data6_p2[i]->LoOP = 0;
        //    fprintf(fp6,"%f,%f,%f\n",p->Data6_p2[i]->traffic_norm,p->Data6_p2[i]->n_flow_norm,p->Data6_p2[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp6_p2 = 1.0*p->Data6_p2[i]->LoOP;
            if((p->loOP_threshold6_p2<temp6_p2) && (temp6_p2 >= 0) && (temp6_p2 < 1))
               p->loOP_threshold6_p2=temp6_p2;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if (p->training6_p2 == 6)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state6_p2,p->Data6_p2,p->data_counter6_p2);
         p->loOP_status6_p2 = LoOP_udate(p->state6_p2,p->Data6_p2);
	...
	trigger_send_anomaly_detection6_p2(p);
      ...
      p->last_recorded_n_bytes6_p2=(double)now_recorded_n_bytes6_p2;
      p->last_recorded_n_flow6_p2=now_recorded_n_flow6_p2;
     ...
     {    
        ...
        // if (p->data_counter6_p3 < DATANUM && p->writing6_p3 ==1)
        ...
        /*start calculating*/
        else if (p->writing6_p3 == 6)
        { 
            p->data_counter6_p3=DATANUM;
          p->training6_p3=6;
          gettimeofday(&start6_p3,NULL);          
        //   while(p->data_counter6_p3<DATANUM)
        //   {
        //       //read from fp to flow_arr and traffic_arr
        //     short ret_val6 = fscanf(fp6,"%f,%f",&p->flow_arr6_p3[p->data_counter6_p3],&p->traffic_arr6_p3[p->data_counter6_p3]);
        //     p->data_counter6_p3++;
        //     if (ret_val6 == 0)
        //       printf("no character read \n");
        //   }
        //   fclose(fp6);              
          p->traffic_mu6_p3=calc_mu(p->traffic_arr6_p3,p->data_counter6_p3);
          p->traffic_sigma6_p3=calc_sigma(p->traffic_arr6_p3,p->data_counter6_p3);
          p->flow_mu6_p3=calc_mu(p->flow_arr6_p3,p->data_counter6_p3);
          p->flow_sigma6_p3=calc_sigma(p->flow_arr6_p3,p->data_counter6_p3);
                  
          for (int i=0;i<p->data_counter6_p3;i++)
          { 
            p->Data6_p3[i]->traffic_norm=normalize(p->traffic_arr6_p3[i],p->traffic_mu6_p3,p->traffic_sigma6_p3);
            p->Data6_p3[i]->n_flow_norm=normalize(p->flow_arr6_p3[i],p->flow_mu6_p3,p->flow_sigma6_p3);
          }
        ...
        //   fp6= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/debug6_p3.log","a+");
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data6_p3[i]->LoOP = LoOP(p->Data6_p3[i],p->Data6_p3);
           if (!(p->Data6_p3[i]->LoOP >=0 && p->Data6_p3[i]->LoOP <= 1))
                p->Data6_p3[i]->LoOP = 0;
        //    fprintf(fp6,"%f,%f,%f\n",p->Data6_p3[i]->traffic_norm,p->Data6_p3[i]->n_flow_norm,p->Data6_p3[i]->LoOP);
            /*if (p->Data[i]->LoOP >=0 && p->Data[i]->LoOP <=1)          
               p->sum_loop+=p->Data[i]->LoOP;*/
           temp6_p3 = 1.0*p->Data6_p3[i]->LoOP;
            if((p->loOP_threshold6_p3<temp6_p3) && (temp6_p3 >= 0) && (temp6_p3 < 1))
               p->loOP_threshold6_p3=temp6_p3;
            //    else 
            //    if ((temp < p->loOP_threshold) && (temp > max_sec))
            //    max_sec = temp;
          }
      ...
      else if (p->training6_p3 == 6)
      {
         ...
         // p->lof_status=calc_LOF(p->Data,p->data_counter,p->state);
         make_NN_udate(p->state6_p3,p->Data6_p3,p->data_counter6_p3);
         p->loOP_status6_p3 = LoOP_udate(p->state6_p3,p->Data6_p3);
      ...
      p->last_recorded_n_bytes6_p3=(double)now_recorded_n_bytes6_p3;
      p->last_recorded_n_flow6_p3=now_recorded_n_flow6_p3;
      p->last_time6=current_time6;  
    }
}
...
ofproto_run(struct ofproto *p)
{
    ...
    if (p->datapath_id == 0000000000000001)
    {
        abnormal_detect1(p);
    }
    if (p->datapath_id == 0000000000000002)
    {
        abnormal_detect2(p);
    }
    if (p->datapath_id == 0000000000000003)
    {
        abnormal_detect3(p);
    }
    if (p->datapath_id == 0000000000000004)
    {
        abnormal_detect4(p);
    }
    if (p->datapath_id == 0000000000000005)
    {
        abnormal_detect5(p);
    }
    if (p->datapath_id == 0000000000000006)
    {
        abnormal_detect6(p);
    }
    // trigger_send_anomaly_detection(p); 
...
/*define trigger_send_anomaly_detection*/
void trigger_send_anomaly_detection(struct ofproto *ofproto)
{
  printf("just trigger_send_anomaly_detection\n");
  connmgr_send_anomaly_detection(ofproto->connmgr);
}
void trigger_send_anomaly_detection_p2(struct ofproto *ofproto)
{
    printf("just trigger_send_anomaly_detection\n");
    connmgr_send_anomaly_detection_p2(ofproto->connmgr);
}
void trigger_send_anomaly_detection2_p1(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection2_p1(ofproto->connmgr);
}
void trigger_send_anomaly_detection2_p2(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection2_p2(ofproto->connmgr);
}
void trigger_send_anomaly_detection3_p1(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection3_p1(ofproto->connmgr);
}
void trigger_send_anomaly_detection3_p2(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection3_p2(ofproto->connmgr);
}
void trigger_send_anomaly_detection4_p1(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection4_p1(ofproto->connmgr);
}
void trigger_send_anomaly_detection4_p2(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection4_p2(ofproto->connmgr);
}
void trigger_send_anomaly_detection4_p3(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection4_p3(ofproto->connmgr);
}
void trigger_send_anomaly_detection4_p4(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection4_p4(ofproto->connmgr);
}
void trigger_send_anomaly_detection5_p1(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection5_p1(ofproto->connmgr);
}
void trigger_send_anomaly_detection5_p2(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection5_p2(ofproto->connmgr);
}
void trigger_send_anomaly_detection5_p3(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection5_p3(ofproto->connmgr);
}
void trigger_send_amomaly_detection6_p1(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection6_p1(ofproto->connmgr);
}
void trigger_send_anomaly_detection6_p2(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection6_p2(ofproto->connmgr);
}
void trigger_send_anomaly_detection6_p3(struct ofproto *ofproto)
{
    connmgr_send_anomaly_detection6_p3(ofproto->connmgr);
}
void
...
/*
int get_stat(ofp_port_t port_no,struct ofproto *ofproto;)
{
    struct ofport *port;    
    port = ofproto_get_port(ofproto, port_no);
    struct ofputil_port_stats ops = { .port_no = port->pp.port_no };
    ofproto_port_get_stats(port, &ops.stats);
    fp=fopen("/home/tuyen/testport.log","w");
    fprintf(fp,"%d",ops.stats.rx_packets);
    fclose(fp);
    return ops.stats.rxpackets;
    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    case OFPTYPE_ANOMALY_DETECTION_O:     
    case OFPTYPE_ANOMALY_DETECTION_T_O:      
    case OFPTYPE_ANOMALY_DETECTION_T_T:     
    case OFPTYPE_ANOMALY_DETECTION_TH_O:      
    case OFPTYPE_ANOMALY_DETECTION_TH_T:    
    case OFPTYPE_ANOMALY_DETECTION_FO_O:   
    case OFPTYPE_ANOMALY_DETECTION_FO_T:    
    case OFPTYPE_ANOMALY_DETECTION_FO_TH: 
    case OFPTYPE_ANOMALY_DETECTION_FO_F:    
    case OFPTYPE_ANOMALY_DETECTION_FI_O:    
    case OFPTYPE_ANOMALY_DETECTION_FI_T:  
    case OFPTYPE_ANOMALY_DETECTION_FI_TH:   
    case OFPTYPE_ANOMALY_DETECTION_SI_O:     
    case OFPTYPE_ANOMALY_DETECTION_SI_T:   
    case OFPTYPE_ANOMALY_DETECTION_SI_TH:   
    default:
