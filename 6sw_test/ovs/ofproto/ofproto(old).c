...
void abnormal_detect1(struct ofproto *p)
{
    ...
    //   fp1=fopen("home/fil02/OvS-LoOP/data_recording1.log","a+");
    ...
    //   fp1=fopen("home/fil02/OvS-LoOP/data_recording1_p2.log","a+");
    ...
    //   fclose(fp1);
     ...
     {    
        ...
        //   fclose(fp1);
          ...
          //if (!(current_flow1 <=0 && current_traf1 <=0))
        //   if (!(current_flow1 <=0 && current_traf1 <=0))h
        {
             fp1=fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/training1.log","a+");
          fprintf(fp1, "%f,%f\n",current_flow1,current_traf1);
          fclose(fp1);
      ...
      else 
      {
         ...
         p->loOP_status1 = LoOP_udate(p->state1,p->Data1);
          ...
          fp1= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update1_p1.log","a+");
          fprintf(fp1,"%f\n",p->loOP_status1);
          fclose(fp1);
          }
      }
     ...
     {    
      ...
      else 
      {
         ...
         p->loOP_status1_p2 = LoOP_udate(p->state1_p2,p->Data1_p2);
          ...
          fp1= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update1_p2.log","a+");
          fprintf(fp1,"%f\n",p->loOP_status1_p2);
          fclose(fp1);
          }
      }
...
void abnormal_detect2(struct ofproto *p)
{
    ...
    //   fp2=fopen("home/fil02/OvS-LoOP/data_recording2.log","a+");
    ...
    //   fp2=fopen("home/fil02/OvS-LoOP/data_recording2_p2.log","a+");
     ...
     {    
      ...
      else if (p->training2 ==2)
      {
         ...
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2);
          ...
          fp2= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update2_p1.log","a+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }
     ...
     {    
      ...
      else if (p->training2 ==2)
      {
         ...
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2);
          ...
          fp2= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update2_p2.log","a+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }
...
void abnormal_detect3(struct ofproto *p)
{
    ...
    //   fp3=fopen("home/fil02/OvS-LoOP/data_recording3.log","a+");
    ...
    //   fp3=fopen("home/fil02/OvS-LoOP/data_recording3_p2.log","a+");
     ...
     {    
      ...
      else if(p->training3 == 3)
      {
         ...
         p->loOP_status3 = LoOP_udate(p->state3,p->Data3);
          ...
          fp3= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update3_p1.log","a+");
          fprintf(fp3,"%f\n",p->loOP_status3);
          fclose(fp3);
          }
      }
     ...
     {    
      ...
      else if(p->training3_p2 == 3)
      {
         ...
         p->loOP_status3_p2 = LoOP_udate(p->state3_p2,p->Data3_p2);
          ...
          fp3= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update3_p2.log","a+");
          fprintf(fp3,"%f\n",p->loOP_status3_p2);
          fclose(fp3);
          }
      }
...
{
    struct timeval start4,start4_p2,start4_p3,end4,end4_p2,end4_p3;
    ...
    //   fp4=fopen("home/fil02/OvS-LoOP/data_recording4.log","a+");
    //   fprintf(fp4, "%f,%f,",current_flow4,current_traf4);
    //   fclose(fp4);

    //   fp4=fopen("home/fil02/OvS-LoOP/data_recording4_p2.log","a+");
    //   fprintf(fp4, "%f,%f,",current_flow4_p2,current_traf4_p2);
    //   fclose(fp4);

    //   fp4=fopen("home/fil02/OvS-LoOP/data_recording4_p3.log","a+");
    //   fprintf(fp4, "%f,%f,",current_flow4_p3,current_traf4_p3);
    //   fclose(fp4);
     ...
     {    
      ...
      else if (p->training4 == 4)
      {
         ...
         p->loOP_status4 = LoOP_udate(p->state4,p->Data4);
          ...
          fp4= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update4_p1.log","a+");
          fprintf(fp4,"%f\n",p->loOP_status4);
          fclose(fp4);
          }
     ...
     {    
      ...
      else if (p->training4_p2 == 4)
      {
         ...
         p->loOP_status4_p2 = LoOP_udate(p->state4_p2, p->Data4_p2);
          ...
          fp4= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update4_p2.log","a+");
          fprintf(fp4,"%f\n",p->loOP_status4_p2);
          fclose(fp4);
          }
     ...
     {    
      ...
      else if (p->training4_p3 == 4)
      {
         ...
         p->loOP_status4_p3 = LoOP_udate(p->state4_p3, p->Data4_p3);
          ...
          fp4= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update4_p3.log","a+");
          fprintf(fp4,"%f\n",p->loOP_status4_p3);
          fclose(fp4);
          }
...
{
    struct timeval start5, start5_p2, end5, end5_p2;
    ...
    //   fp5=fopen("home/fil02/OvS-LoOP/data_recording5.log","a+");
    //   fprintf(fp5, "%f,%f,",current_flow5,current_traf5);
    //   fclose(fp5);

    //   fp5=fopen("home/fil02/OvS-LoOP/data_recording5_p2.log","a+");
     ...
     {    
      ...
      else if (p->training5 == 5)
      {
         ...
         p->loOP_status5 = LoOP_udate(p->state5,p->Data5);
          ...
          fp5= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update5_p1.log","a+");
          fprintf(fp5,"%f\n",p->loOP_status5);
          fclose(fp5);
          }
      }
     ...
     {    
      ...
      else if (p->training5_p2 == 5)
      {
         ...
         p->loOP_status5_p2 = LoOP_udate(p->state5_p2,p->Data5_p2);
          ...
          fp5= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update5_p2.log","a+");
          fprintf(fp5,"%f\n",p->loOP_status5_p2);
          fclose(fp5);
          }
      }
...
void abnormal_detect6(struct ofproto *p)
{
    ...
    //   fp6=fopen("home/fil02/OvS-LoOP/data_recording6.log","a+");
    //   fprintf(fp6, "%f,%f,",current_flow6,current_traf6);
    //   fclose(fp6);

    //   fp6=fopen("home/fil02/OvS-LoOP/data_recording6_p2.log","a+");
    //   fprintf(fp6, "%f,%f,",current_flow6_p2, current_traf6_p2);
    //   fclose(fp6);

    //   fp6=fopen("home/fil02/OvS-LoOP/data_recording6_p3.log","a+");
    ...
    //   fclose(fp6);
     ...
     {    
      ...
      else if (p->training6 == 6)
      {
         ...
         p->loOP_status6 = LoOP_udate(p->state6,p->Data6);
          ...
          fp6= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update6_p1.log","a+");
          fprintf(fp6,"%f\n",p->loOP_status6);
          fclose(fp6);
          }
     ...
     {    
        ...
        // /*check training file exist or not .if not exist or not esnough data, recording.
        //   if exists , move to calculating*/
        ...
        //   if (!(current_flow6_p2 <=0 && current_traf6_p2 <=0))
        // if (current_traf6_p2 != 0 && current_flow6_p2 != 0)
        //   fprintf(fp6, "%f,%f\n",current_flow6_p2,current_traf6_p2);
        //   fclose(fp6);
          //if (!(current_flow6_p2 <=0 && current_traf6_p2 <=0))
          if (current_traf6_p2 != 0 && current_flow6_p2 != 0)
      ...
      else if (p->training6_p2 == 6)
      {
         ...
         p->loOP_status6_p2 = LoOP_udate(p->state6_p2,p->Data6_p2);
          ...
          fp6= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update6_p2.log","a+");
          fprintf(fp6,"%f\n",p->loOP_status6_p2);
          fclose(fp6);
          }
     ...
     {    
      ...
      else if (p->training6_p3 == 6)
      {
         ...
         p->loOP_status6_p3 = LoOP_udate(p->state6_p3,p->Data6_p3);
          ...
          fp6= fopen("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/update6_p3.log","a+");
          fprintf(fp6,"%f\n",p->loOP_status6_p3);
          fclose(fp6);
          }
...
ofproto_run(struct ofproto *p)
{
    ...
    // FILE *f;
    // f=fopen("home/fil02/OvS-LoOP/check_dpid.log","a+");
    //   fprintf(f, "%ld\n",p->datapath_id);
    //   fclose(f);
