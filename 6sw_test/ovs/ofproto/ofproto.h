...
int get_packet_counter(struct ofproto *p);

/* Table configuration */

enum ofputil_table_miss ofproto_table_get_miss_config(const struct ofproto *,
                                                      uint8_t table_id);
/*prototype for trigger_send_anomaly_detection*/
void trigger_send_anomaly_detection(struct ofproto *);
void trigger_send_anomaly_detection_p2(struct ofproto *);
void trigger_send_anomaly_detection2_p1(struct ofproto *);
void trigger_send_anomaly_detection2_p2(struct ofproto *);
void trigger_send_anomaly_detection3_p1(struct ofproto *);
void trigger_send_anomaly_detection3_p2(struct ofproto *);
void trigger_send_anomaly_detection4_p1(struct ofproto *);
void trigger_send_anomaly_detection4_p2(struct ofproto *);
void trigger_send_anomaly_detection4_p3(struct ofproto *);
void trigger_send_anomaly_detection4_p4(struct ofproto *);
void trigger_send_anomaly_detection5_p1(struct ofproto *);
void trigger_send_anomaly_detection5_p2(struct ofproto *);
void trigger_send_anomaly_detection5_p3(struct ofproto *);
void trigger_send_amomaly_detection6_p1(struct ofproto *);
void trigger_send_anomaly_detection6_p2(struct ofproto *);
void trigger_send_anomaly_detection6_p3(struct ofproto *);
