...
# subprocess.call("/home/fil02/tuan/lof_capture.sh"
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION)
class OFPAnomalyDetection(MsgBase):
    ...
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        ...
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data11.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_O)
class OFPAnomalyDetection_O(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_O, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload12
        msg = super(OFPAnomalyDetection_O, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload12 = msg.data
        # print(f"Port 2 S1:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data12.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_T_O)
class OFPAnomalyDetection_T_O(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_T_O, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload21
        msg = super(OFPAnomalyDetection_T_O, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload21 = msg.data
        # print(f"Port 1 S2:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data21.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data21.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_T_T)
class OFPAnomalyDetection_T_T(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_T_T, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload22
        msg = super(OFPAnomalyDetection_T_T, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload22 = msg.data
        # print(f"Port 2 S2:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data22.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_TH_O)
class OFPAnomalyDetection_TH_O(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_TH_O, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload31
        msg = super(OFPAnomalyDetection_TH_O, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload31 = msg.data
        # print(f"Port 1 S3:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data31.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data31.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_TH_T)
class OFPAnomalyDetection_TH_T(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_TH_T, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload32
        msg = super(OFPAnomalyDetection_TH_T, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload32 = msg.data
        # print(f"Port 2 S3:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data32.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_FO_O)
class OFPAnomalyDetection_FO_O(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_FO_O, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload41
        msg = super(OFPAnomalyDetection_FO_O, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload41 = msg.data
        # print(f"Port 1 S4:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data41.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data41.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_FO_T)
class OFPAnomalyDetection_FO_T(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_FO_T, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload42
        msg = super(OFPAnomalyDetection_FO_T, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload42 = msg.data
        # print(f"Port 2 S4:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data42.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data42.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_FO_TH)
class OFPAnomalyDetection_FO_TH(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_FO_TH, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload43
        msg = super(OFPAnomalyDetection_FO_TH, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload43 = msg.data
        # print(f"Port 3 S4:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data43.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data43.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_FO_F)
class OFPAnomalyDetection_FO_F(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_FO_F, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload43
        msg = super(OFPAnomalyDetection_FO_F, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload43 = msg.data
        # print(f"Port 4 S4:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data44.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        # with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data44.txt", "a+") as f:
        #     f.seek(0)
        #     data = f.read(30)
        #     if len(data) > 0:
        #         f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_FI_O)
class OFPAnomalyDetection_FI_O(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_FI_O, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload51
        msg = super(OFPAnomalyDetection_FI_O, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload51 = msg.data
        # print(f"Port 1 S5:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data51.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data51.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_FI_T)
class OFPAnomalyDetection_FI_T(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_FI_T, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload52
        msg = super(OFPAnomalyDetection_FI_T, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload52 = msg.data
        # print(f"Port 2 S5:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data52.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data52.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_FI_TH)
class OFPAnomalyDetection_FI_TH(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_FI_TH, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload52
        msg = super(OFPAnomalyDetection_FI_TH, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload52 = msg.data
        # print(f"Port 3 S5:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data53.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        # with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data53.txt", "a+") as f:
        #     f.seek(0)
        #     data = f.read(30)
        #     if len(data) > 0:
        #         f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_SI_O)
class OFPAnomalyDetection_SI_O(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_SI_O, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload61
        msg = super(OFPAnomalyDetection_SI_O, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload61 = msg.data
        # print(f"Port 1 S6:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data61.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        # #print("Anomaly Detect!!!")
        # subprocess.call("/home/fil02/tuan/lof_capture.sh")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_SI_T)
class OFPAnomalyDetection_SI_T(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_SI_T, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload62
        msg = super(OFPAnomalyDetection_SI_T, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload62 = msg.data 
        # print(f"Port 2 S6:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data62.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data62.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
@_register_parser
@_set_msg_type(ofproto.OFPT_ANOMALY_DETECTION_SI_TH)
class OFPAnomalyDetection_SI_TH(MsgBase):
    def __init__(self, datapath, data=None):
        super(OFPAnomalyDetection_SI_TH, self).__init__(datapath)
        self.data = data

    @classmethod
    def parser(cls, datapath, version, msg_type, msg_len, xid, buf):
        # global payload63
        msg = super(OFPAnomalyDetection_SI_TH, cls).parser(datapath, version, msg_type,
                                                msg_len, xid, buf)
        msg.data = msg.buf[ofproto.OFP_HEADER_SIZE:]
        # payload63 = msg.data
        # print(f"Port 3 S6:",msg.data)
        # f = open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data63.txt", "w")
        # f.write(str(msg.data))
        # f.close()
        with open("/home/hollahieu/Desktop/6sw/6sw_port_fil-master/data63.txt", "a+") as f:
            f.seek(0)
            data = f.read(30)
            if len(data) > 0:
                f.write("\n")
...
#         self.copy_of_image = Image.open("/home/hollahieu/Desktop/NguyenMinhHIeu_20172545/6sw_topo.png")
...
#         self.center_frame = Frame(self.frame, relief='raised', borderwidth=2)
#         self.center_frame.place(relx=0.52, rely=0.45, anchor=CENTER)

#         self.center_frame1 = Frame(self.frame, relief='raised', borderwidth=2)
#         self.center_frame1.place(relx=0.3, rely=0.3, anchor=CENTER)

#         self.center_frame2 = Frame(self.frame, relief='raised', borderwidth=2)
#         self.center_frame2.place(relx=0.3, rely=0.54, anchor=CENTER)

#         self.center_frame3 = Frame(self.frame, relief='raised', borderwidth=2)
#         self.center_frame3.place(relx=0.3, rely=0.78, anchor=CENTER)

#         self.center_frame4 = Frame(self.frame, relief='raised', borderwidth=2)
#         self.center_frame4.place(relx=0.52, rely=0.69, anchor=CENTER)

#         self.center_frame5 = Frame(self.frame, relief='raised', borderwidth=2)
#         self.center_frame5.place(relx=0.8, rely=0.6, anchor=CENTER)
        
#         self.L1 = Label(self.center_frame, text='0', width=20)
#         self.L1.pack()
#         self.L2 = Label(self.center_frame1, text='0', width=20)
#         self.L2.pack()
#         self.L3 = Label(self.center_frame2, text='0', width=20)
#         self.L3.pack()
#         self.L4 = Label(self.center_frame3, text='0', width=20)
#         self.L4.pack()
#         self.L5 = Label(self.center_frame4, text='0', width=20)
#         self.L5.pack()
#         self.L6 = Label(self.center_frame5, text='0', width=20)
#         self.L6.pack()
...
#         self.L1.config(text=payload11)
#         self.L2.config(text=payload21)
#         self.L3.config(text=payload31)
#         self.L4.config(text=payload41)
#         self.L5.config(text=payload51)
#         self.L6.config(text=payload61)
...
# print("payload11 = ", payload11)
# print("payload21 = ", payload21)
# print("payload31 = ", payload31)
# print("payload42 = ", payload42)
# print("payload43 = ", payload43)
# print("payload52 = ", payload52)
# print("payload62 = ", payload62)
# print("payload63 = ", payload63)
